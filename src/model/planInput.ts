...
export class PlanInput {
    ...
    */
    'assigneeType': PlanInput.AssigneeTypeEnum;
    /**
    ...
    */
    'effortPersistenceType'?: PlanInput.EffortPersistenceTypeEnum;
    /**
    ...
    */
    'planItemType': PlanInput.PlanItemTypeEnum;
    /**
...
export namespace PlanInput {
    export enum AssigneeTypeEnum {
        User = <any> 'USER',
        Generic = <any> 'GENERIC'
    }
    export enum EffortPersistenceTypeEnum {
        SecondsPerDay = <any> 'SECONDS_PER_DAY',
        TotalSeconds = <any> 'TOTAL_SECONDS'
    }
