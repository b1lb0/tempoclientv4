...
export class SkillsAssignmentInput {
    /**
    ...
    */
    'assigneeType': SkillsAssignmentInput.AssigneeTypeEnum;
    /**
    * A list of `Skill` ids
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "SkillsAssignmentInput.AssigneeTypeEnum"
        },
        {
            "name": "skillIds",
            "baseName": "skillIds",
    ...
    static getAttributeTypeMap() {
        return SkillsAssignmentInput.attributeTypeMap;
    }
}

export namespace SkillsAssignmentInput {
