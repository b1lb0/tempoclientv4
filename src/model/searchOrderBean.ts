...
*/
export class SearchOrderBean {
    /**
    * Order results by the specified field
    */
    'field': SearchOrderBean.FieldEnum;
    /**
    * Order results by the specified order. `ASC` for smallest to largest, and `DESC` for largest to smallest
    */
    'order': SearchOrderBean.OrderEnum;
...
export namespace SearchOrderBean {
    export enum FieldEnum {
        Id = <any> 'ID',
        StartDateTime = <any> 'START_DATE_TIME',
        Updated = <any> 'UPDATED'
    }
