...
export class FlexPlan {
    /**
    * The description of the `FlexPlan`
    */
    'description'?: string;
    /**
    * The ending date of the `FlexPlan`
    */
    'endDate'?: string;
    /**
    * The id of the `FlexPlan`
    */
    'id': number;
    /**
    * The issue ID for the `FlexPlan`
    */
    'issueId'?: number;
    /**
    * The total amount of time planned in seconds
    */
    ...
    */
    'self': string;
    /**
    * The starting date of the `FlexPlan`
    */
    'startDate'?: string;
    /**
    * The id of the `Team` for the `FlexPlan`
    */
    'teamId'?: number;
    /**
    * The title of the `FlexPlan`
    */
    'title'?: string;
    ...
    static getAttributeTypeMap() {
        return FlexPlan.attributeTypeMap;
    }
}
