...
export class CreateWorkAttributeInput {
    /**
...
export namespace CreateWorkAttributeInput {
    export enum TypeEnum {
        Account = <any> 'ACCOUNT',
        Checkbox = <any> 'CHECKBOX',
        InputField = <any> 'INPUT_FIELD',
        InputNumeric = <any> 'INPUT_NUMERIC',
        StaticList = <any> 'STATIC_LIST'
    }
}
