...
export class PlanSearchInput {
    ...
    */
    'assigneeTypes'?: PlanSearchInput.AssigneeTypesEnum;
    /**
    ...
    */
    'genericResourceIds'?: Array<number>;
    /**
...
export namespace PlanSearchInput {
    export enum AssigneeTypesEnum {
        User = <any> 'USER',
        Generic = <any> 'GENERIC'
    }
    export enum PlanItemTypesEnum {
        Issue = <any> 'ISSUE',
        Project = <any> 'PROJECT'
    }
    export enum PlannedTimeBreakdownEnum {
        Daily = <any> 'DAILY',
        Period = <any> 'PERIOD'
    }
}
