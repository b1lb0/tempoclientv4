...
*/
export class PlanApprovalInput {
    /**
    ...
    */
    'status'?: PlanApprovalInput.StatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "PlanApprovalInput.StatusEnum"
        }    ];

    static getAttributeTypeMap() {
        return PlanApprovalInput.attributeTypeMap;
    }
}

export namespace PlanApprovalInput {
