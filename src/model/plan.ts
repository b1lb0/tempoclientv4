...
export class Plan {
    ...
    */
    'description'?: string;
    /**
    * Can be either `SECONDS_PER_DAY` or `TOTAL_SECONDS`.
    */
    ...
    */
    ...
    /**
    * The Jira user account id of the plan creator.
    */
    'planCreatorId'?: string;
    'planItem'?: PlanItem;
    /**
    * The amount of seconds that will be invested daily in the `Plan` if `effortPersistanceType` is `SECONDS_PER_DAY`.
    */
    ...
    */
    'startTime'?: string;
    /**
    * can be  `JIRA_ISSUE` if this is a synced plan, otherwise `NONE`.
    */
    'syncSource'?: string;
    /**
    * The total amount of seconds planned for the `Plan` if `effortPersistanceType` is `TOTAL_SECONDS`.
    */
    'totalPlannedSeconds'?: number;
    /**
    * The total amount of seconds planned for the `Plan` in scope of the supplied date range.
    */
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "totalPlannedSeconds",
            "baseName": "totalPlannedSeconds",
            "type": "number"
        },
        {
            "name": "totalPlannedSecondsInScope",
            "baseName": "totalPlannedSecondsInScope",
            "type": "number"
        },
        {
            "name": "updatedAt",
