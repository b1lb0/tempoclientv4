...
export class GenericResourceTeamMembers {
    /**
    ...
    */
    'members': Array<GenericResourceReference>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "members",
            "baseName": "members",
            "type": "Array<GenericResourceReference>"
        },
        {
            "name": "self",
            "baseName": "self",
    ...
    static getAttributeTypeMap() {
        return GenericResourceTeamMembers.attributeTypeMap;
    }
}
