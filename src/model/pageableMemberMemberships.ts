...
export class PageableMemberMemberships {
    'metadata': PageableMetadata;
    'results': Array<MemberMemberships>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "metadata",
            "baseName": "metadata",
            "type": "PageableMetadata"
        },
        {
            "name": "results",
            "baseName": "results",
            "type": "Array<MemberMemberships>"
        },
        {
            "name": "self",
            "baseName": "self",
    ...
    static getAttributeTypeMap() {
        return PageableMemberMemberships.attributeTypeMap;
    }
}
