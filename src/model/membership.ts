...
export class Membership {
    ...
    */
    'id': number;
    /**
    * Inclusive end date of the `Membership`.
    */
    'inclusiveTo'?: string;
    'member'?: Self;
    'role': RoleReference;
    ...
    */
    ...
    'team'?: Self;
    /**
    * Exclusive end date of the `Membership. This is the day after the last day of the `Membership`. In our API, end dates of date ranges are inclusive except for the team membership `to` date. This was mistakenly introduced like this and we need to keep it like this for backward compatibility. Therefore we are adding a new field `toInclusive` so that going forward users can use that field to get the inclusive end date and not needing to account for the of by one date.
    */
    'to'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "commitmentPercent",
            "baseName": "commitmentPercent",
            "type": "number"
        },
        {
            "name": "from",
    ...
    static getAttributeTypeMap() {
        return Membership.attributeTypeMap;
    }
}
