...
import { MembershipInput } from '../model/membershipInput';
import { MembershipSearchInput } from '../model/membershipSearchInput';
import { TeamMembership } from '../model/teamMembership';
import { TeamMembershipInput } from '../model/teamMembershipInput';
import { TeamMembershipResults } from '../model/teamMembershipResults';
import { TeamMembershipResultsPageable } from '../model/teamMembershipResultsPageable';
...
export enum TeamMembershipsApiApiKeys {
}
...
export class TeamMembershipsApi {
    ...
    public setApiKey(key: TeamMembershipsApiApiKeys, value: string) {
        (this.authentications as any)[TeamMembershipsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param teamMembershipInput 
     */
    public async createMembership (teamMembershipInput?: TeamMembershipInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TeamMembership;  }> {
        const localVarPath = this.basePath + '/team-memberships';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(teamMembershipInput, "TeamMembershipInput")
        };
     ...
     * @param id 
     */
    public async deleteMembership (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/team-memberships/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteMembership.');
        }
     ...
     * @param teamId 
     */
    public async getAllMemberships (teamId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TeamMembershipResults;  }> {
        const localVarPath = this.basePath + '/team-memberships/team/{teamId}'
        ...
        if (teamId === null || teamId === undefined) {
            throw new Error('Required parameter teamId was null or undefined when calling getAllMemberships.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TeamMembershipResults;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TeamMembershipResults");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param id 
     */
    public async getMembership (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TeamMembership;  }> {
        const localVarPath = this.basePath + '/team-memberships/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getMembership.');
        }
     ...
     * @param membershipSearchInput 
     */
    public async searchMemberships (offset?: number, limit?: number, membershipSearchInput?: MembershipSearchInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TeamMembershipResultsPageable;  }> {
        const localVarPath = this.basePath + '/team-memberships/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(membershipSearchInput, "MembershipSearchInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TeamMembershipResultsPageable;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TeamMembershipResultsPageable");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async updateMembership (id: string, membershipInput?: MembershipInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TeamMembership;  }> {
        const localVarPath = this.basePath + '/team-memberships/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updateMembership.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(membershipInput, "MembershipInput")
        };
