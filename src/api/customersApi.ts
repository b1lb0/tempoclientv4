...
import { CustomerInput } from '../model/customerInput';
import { CustomerSearchInput } from '../model/customerSearchInput';
import { PageableAccount } from '../model/pageableAccount';
import { PageableCustomer } from '../model/pageableCustomer';
...
export class CustomersApi {
     ...
     * @param customerInput 
     */
    public async createCustomer (customerInput?: CustomerInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Customer;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(customerInput, "CustomerInput")
        };
     ...
     * @param key 
     */
    public async deleteCustomer (key: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/customers/{key}'
        ...
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling deleteCustomer.');
        }
     ...
     * @param id An integer uniquely identifying the customer
     * @param offset Skip over a number of elements by specifying an offset value for the query
     * @param limit Limit the number of elements on the response
     */
    public async getCustomerAccounts (id: number, offset?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageableAccount;  }> {
     ...
     * @param id 
     */
    public async getCustomerById (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Customer;  }> {
     ...
     * @param limit Limit the number of elements on the response
     */
    public async getCustomers (offset?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageableCustomer;  }> {
        const localVarPath = this.basePath + '/customers';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PageableCustomer;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PageableCustomer");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param offset Skip over a number of elements by specifying an offset value for the query
     * @param limit Limit the number of elements on the response
     * @param customerSearchInput 
     */
    public async searchCustomers (offset?: number, limit?: number, customerSearchInput?: CustomerSearchInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageableCustomer;  }> {
        const localVarPath = this.basePath + '/customers/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(customerSearchInput, "CustomerSearchInput")
        };
     ...
     * @param customerInput 
     */
    public async updateCustomer (key: string, customerInput?: CustomerInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Customer;  }> {
        const localVarPath = this.basePath + '/customers/{key}'
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling updateCustomer.');
        }
