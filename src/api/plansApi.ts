...
import { PageablePlan } from '../model/pageablePlan';
import { PageablePlanBeanWithoutLinks } from '../model/pageablePlanBeanWithoutLinks';
import { Plan } from '../model/plan';
import { PlanInput } from '../model/planInput';
import { PlanResults } from '../model/planResults';
import { PlanSearchInput } from '../model/planSearchInput';
...
export class PlansApi {
     ...
     * @param planInput 
     */
    public async createPlan (planInput?: PlanInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Plan;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(planInput, "PlanInput")
        };
     ...
     * @param id An id that uniquely identifies the Plan
     * @param day The day to delete in format yyyy-MM-dd
     */
    public async deleteDayFromPlan (id: number, day: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/plans/{id}/partial/{day}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteDayFromPlan.');
        }

        // verify required parameter 'day' is not null or undefined
        if (day === null || day === undefined) {
            throw new Error('Required parameter day was null or undefined when calling deleteDayFromPlan.');
        }
     ...
     * @param id An id that uniquely identifies the Plan
     */
    public async deletePlanById (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deletePlanById.');
        }
     ...
     * @param to 
     */
    public async getPlanById (id: number, from?: string, to?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Plan;  }> {
        const localVarPath = this.basePath + '/plans/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getPlanById.');
        }
     ...
     * @param from Retrieve plans starting with this date.
     * @param to Retrieve plans that ends up to and including this date.
     * @param accountIds Ids of the user assignees you want to search plans for.
     * @param assigneeTypes Types of the assignees you want to search plans for.
     * @param genericResourceIds Ids of the generic resources you want to search plans for.
     * @param limit Maximum number of results on each page.
     * @param offset Number of skipped results.
     * @param planIds Ids of the plans you want to search for.
     * @param planItemIds Ids of the items you want to search plans for.
     * @param planItemTypes Types of the items you want to search plans for.
     * @param plannedTimeBreakdown Defines how detailed you would like to see the breakdown of the planned time for each &#x60;Plan&#x60;.
     * @param updatedFrom Retrieve plans that have been updated from this date.
     */
    public async getPlans (from: string, to: string, accountIds?: Array<string>, assigneeTypes?: Array<'USER' | 'GENERIC'>, genericResourceIds?: Array<number>, limit?: number, offset?: number, planIds?: Array<number>, planItemIds?: Array<number>, planItemTypes?: Array<'ISSUE' | 'PROJECT'>, plannedTimeBreakdown?: Array<'DAILY' | 'PERIOD'>, updatedFrom?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageablePlan;  }> {
        const localVarPath = this.basePath + '/plans';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling getPlans.');
        }

        // verify required parameter 'to' is not null or undefined
        if (to === null || to === undefined) {
            throw new Error('Required parameter to was null or undefined when calling getPlans.');
        }

        if (accountIds !== undefined) {
            localVarQueryParameters['accountIds'] = ObjectSerializer.serialize(accountIds, "Array<string>");
        }

        if (assigneeTypes !== undefined) {
            localVarQueryParameters['assigneeTypes'] = ObjectSerializer.serialize(assigneeTypes, "Array<'USER' | 'GENERIC'>");
        }
        ...
        if (genericResourceIds !== undefined) {
            localVarQueryParameters['genericResourceIds'] = ObjectSerializer.serialize(genericResourceIds, "Array<number>");
        }
        ...
        if (planIds !== undefined) {
            localVarQueryParameters['planIds'] = ObjectSerializer.serialize(planIds, "Array<number>");
        }

        if (planItemIds !== undefined) {
            localVarQueryParameters['planItemIds'] = ObjectSerializer.serialize(planItemIds, "Array<number>");
        }

        if (planItemTypes !== undefined) {
            localVarQueryParameters['planItemTypes'] = ObjectSerializer.serialize(planItemTypes, "Array<'ISSUE' | 'PROJECT'>");
        }

        if (plannedTimeBreakdown !== undefined) {
            localVarQueryParameters['plannedTimeBreakdown'] = ObjectSerializer.serialize(plannedTimeBreakdown, "Array<'DAILY' | 'PERIOD'>");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PageablePlan;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PageablePlan");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param genericResourceId Id of the generic resource you want to search plans for
     * @param plannedTimeBreakdown Defines how detailed you would like to see the breakdown of the planned time for each plan.You can add one or both of these values as query params [DAILY, PERIOD] to see more detailed breakdown of planned time.
     * @param from Retrieve plans starting with this date
     * @param to Retrieve plans that ends up to and including this date
     * @param updatedFrom Retrieve plans that have been updated from this date
     */
    public async getPlansForGenericResource (genericResourceId: number, plannedTimeBreakdown?: Array<string>, from?: string, to?: string, updatedFrom?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PlanResults;  }> {
        const localVarPath = this.basePath + '/plans/generic-resource/{genericResourceId}'
            .replace('{' + 'genericResourceId' + '}', encodeURIComponent(String(genericResourceId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'genericResourceId' is not null or undefined
        if (genericResourceId === null || genericResourceId === undefined) {
            throw new Error('Required parameter genericResourceId was null or undefined when calling getPlansForGenericResource.');
        }

        if (plannedTimeBreakdown !== undefined) {
            localVarQueryParameters['plannedTimeBreakdown'] = ObjectSerializer.serialize(plannedTimeBreakdown, "Array<string>");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PlanResults;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PlanResults");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param accountId Id of the user you want to search plans for
     * @param plannedTimeBreakdown Defines how detailed you would like to see the breakdown of the planned time for each plan.You can add one or both of these values as query params [DAILY, PERIOD] to see more detailed breakdown of planned time.
     * @param from Retrieve plans starting with this date
     * @param to Retrieve plans that ends up to and including this date
     * @param updatedFrom Retrieve plans that have been updated from this date
     */
    public async getPlansForUser (accountId: string, plannedTimeBreakdown?: Array<string>, from?: string, to?: string, updatedFrom?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PlanResults;  }> {
        const localVarPath = this.basePath + '/plans/user/{accountId}'
        ...
        if (accountId === null || accountId === undefined) {
            throw new Error('Required parameter accountId was null or undefined when calling getPlansForUser.');
        }
     ...
     * @param planSearchInput 
     */
    public async searchPlans (planSearchInput?: PlanSearchInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageablePlanBeanWithoutLinks;  }> {
        const localVarPath = this.basePath + '/plans/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(planSearchInput, "PlanSearchInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PageablePlanBeanWithoutLinks;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PageablePlanBeanWithoutLinks");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param id An id that uniquely identifies the Plan
     * @param day The day to update in format yyyy-MM-dd
     * @param planInput 
     */
    public async updatePartialPlan (id: number, day: string, planInput?: PlanInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Plan;  }> {
        const localVarPath = this.basePath + '/plans/{id}/partial/{day}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)))
            .replace('{' + 'day' + '}', encodeURIComponent(String(day)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updatePartialPlan.');
        }

        // verify required parameter 'day' is not null or undefined
        if (day === null || day === undefined) {
            throw new Error('Required parameter day was null or undefined when calling updatePartialPlan.');
        }
     ...
     * @param planInput 
     */
    public async updatePlan (id: number, planInput?: PlanInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Plan;  }> {
        const localVarPath = this.basePath + '/plans/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
