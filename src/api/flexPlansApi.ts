...
import { FlexPlan } from '../model/flexPlan';
import { FlexPlanInput } from '../model/flexPlanInput';
import { FlexPlanSearchInput } from '../model/flexPlanSearchInput';
import { FlexPlanSearchResult } from '../model/flexPlanSearchResult';
...
export enum FlexPlansApiApiKeys {
}

export class FlexPlansApi {
    ...
    public setApiKey(key: FlexPlansApiApiKeys, value: string) {
        (this.authentications as any)[FlexPlansApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param flexPlanInput 
     */
    public async createFlexPlan (flexPlanInput?: FlexPlanInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlexPlan;  }> {
        const localVarPath = this.basePath + '/flex-plans';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(flexPlanInput, "FlexPlanInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlexPlan;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FlexPlan");
     ...
     * @param id An id that uniquely identifies the Flex Plan
     */
    public async deleteFlexPlanById (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/flex-plans/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteFlexPlanById.');
        }
     ...
     * @param id An id that uniquely identifies the Flex Plan
     */
    public async getFlexPlanById (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlexPlan;  }> {
        const localVarPath = this.basePath + '/flex-plans/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getFlexPlanById.');
        }
     ...
     * @param flexPlanSearchInput 
     */
    public async searchFlexPlans (flexPlanSearchInput?: FlexPlanSearchInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlexPlanSearchResult;  }> {
        const localVarPath = this.basePath + '/flex-plans/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(flexPlanSearchInput, "FlexPlanSearchInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlexPlanSearchResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FlexPlanSearchResult");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param flexPlanInput 
     */
    public async updateFlexPlan (id: number, flexPlanInput?: FlexPlanInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlexPlan;  }> {
        const localVarPath = this.basePath + '/flex-plans/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updateFlexPlan.');
        }
