...
import { GenericResourceInput } from '../model/genericResourceInput';
import { GenericResourceSearchInput } from '../model/genericResourceSearchInput';
import { PageableGenericResourceWithoutSelfLink } from '../model/pageableGenericResourceWithoutSelfLink';
...
export enum GenericResourcesApiApiKeys {
}

export class GenericResourcesApi {
    ...
    public setApiKey(key: GenericResourcesApiApiKeys, value: string) {
        (this.authentications as any)[GenericResourcesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createGenericResource (genericResourceInput?: GenericResourceInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericResource;  }> {
        const localVarPath = this.basePath + '/generic-resources';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(genericResourceInput, "GenericResourceInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GenericResource;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "GenericResource");
     ...
     */
    public async deleteGenericResource (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/generic-resources/{id}'
     ...
     * @param genericResourceInput 
     */
    public async editGenericResource (id: number, genericResourceInput?: GenericResourceInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericResource;  }> {
        const localVarPath = this.basePath + '/generic-resources/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param id An id that uniquely identifies the Generic Resource
     */
    public async getGenericResource (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericResource;  }> {
        const localVarPath = this.basePath + '/generic-resources/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async searchGenericResources (genericResourceSearchInput?: GenericResourceSearchInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageableGenericResourceWithoutSelfLink;  }> {
        const localVarPath = this.basePath + '/generic-resources/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(genericResourceSearchInput, "GenericResourceSearchInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PageableGenericResourceWithoutSelfLink;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PageableGenericResourceWithoutSelfLink");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
