...
import { HolidayInput } from '../model/holidayInput';
import { HolidayResults } from '../model/holidayResults';
import { HolidayScheme } from '../model/holidayScheme';
import { HolidaySchemeInputBean } from '../model/holidaySchemeInputBean';
import { HolidaySchemeMembersInput } from '../model/holidaySchemeMembersInput';
import { HolidaySchemeResults } from '../model/holidaySchemeResults';
...
export enum HolidaySchemesApiApiKeys {
}

export class HolidaySchemesApi {
    ...
    public setApiKey(key: HolidaySchemesApiApiKeys, value: string) {
        (this.authentications as any)[HolidaySchemesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param holidayInput 
     */
    public async createHoliday (schemeId: string, holidayInput?: HolidayInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Holiday;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/holidays'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(holidayInput, "HolidayInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Holiday;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Holiday");
     ...
     */
    public async createHolidayScheme (holidaySchemeInputBean?: HolidaySchemeInputBean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HolidayScheme;  }> {
        const localVarPath = this.basePath + '/holiday-schemes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(holidaySchemeInputBean, "HolidaySchemeInputBean")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: HolidayScheme;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "HolidayScheme");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async deleteHoliday (schemeId: string, holidayId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/holidays/{holidayId}'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)))
     ...
     * @param schemeId The id of the Scheme
     */
    public async deleteHolidayScheme (schemeId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * @param schemeId The id of the Scheme
     */
    public async getFloatingHolidays (schemeId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HolidayResults;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/holidays/floating'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: HolidayResults;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "HolidayResults");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param holidayId The id of the holiday
     */
    public async getHoliday (schemeId: string, holidayId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Holiday;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/holidays/{holidayId}'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)))
            .replace('{' + 'holidayId' + '}', encodeURIComponent(String(holidayId)));
        let localVarQueryParameters: any = {};
     ...
     * @param schemeId The id of the Scheme
     */
    public async getHolidayScheme (schemeId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HolidayScheme;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getHolidaySchemes (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HolidaySchemeResults;  }> {
        const localVarPath = this.basePath + '/holiday-schemes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: HolidaySchemeResults;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "HolidaySchemeResults");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getHolidays (schemeId: string, year?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HolidayResults;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/holidays'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getUserHolidayScheme (accountId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HolidayScheme;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/users/{accountId}'
     ...
     */
    public async getWorkloadSchemeMembers (schemeId: string, offset?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageableUser;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/members'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PageableUser;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PageableUser");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param schemeId The id of the Scheme
     */
    public async setDefaultScheme (schemeId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HolidayScheme;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/default'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     */
    public async setWorkloadSchemeMembership (schemeId: string, holidaySchemeMembersInput?: HolidaySchemeMembersInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/members'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(holidaySchemeMembersInput, "HolidaySchemeMembersInput")
        };
     ...
     * @param holidayInput 
     */
    public async updateHoliday (schemeId: string, holidayId: string, holidayInput?: HolidayInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Holiday;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}/holidays/{holidayId}'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)))
            .replace('{' + 'holidayId' + '}', encodeURIComponent(String(holidayId)));
        let localVarQueryParameters: any = {};
     ...
     * @param holidaySchemeInputBean 
     */
    public async updateHolidayScheme (schemeId: string, holidaySchemeInputBean?: HolidaySchemeInputBean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HolidayScheme;  }> {
        const localVarPath = this.basePath + '/holiday-schemes/{schemeId}'
            .replace('{' + 'schemeId' + '}', encodeURIComponent(String(schemeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
