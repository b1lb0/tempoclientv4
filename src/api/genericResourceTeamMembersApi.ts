...
import { GenericResourceTeamMember } from '../model/genericResourceTeamMember';
import { GenericResourceTeamMemberInput } from '../model/genericResourceTeamMemberInput';
import { GenericResourceTeamMembers } from '../model/genericResourceTeamMembers';
...
export enum GenericResourceTeamMembersApiApiKeys {
}

export class GenericResourceTeamMembersApi {
    ...
    public setApiKey(key: GenericResourceTeamMembersApiApiKeys, value: string) {
        (this.authentications as any)[GenericResourceTeamMembersApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async addResourceToTeam (teamId: number, genericResourceTeamMemberInput?: GenericResourceTeamMemberInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericResourceTeamMember;  }> {
        const localVarPath = this.basePath + '/teams/{teamId}/generic-resources'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(genericResourceTeamMemberInput, "GenericResourceTeamMemberInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GenericResourceTeamMember;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "GenericResourceTeamMember");
     ...
     */
    public async getGenericResourceTeamMember (teamId: number, resourceId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericResourceTeamMember;  }> {
        const localVarPath = this.basePath + '/teams/{teamId}/generic-resources/{resourceId}'
            .replace('{' + 'teamId' + '}', encodeURIComponent(String(teamId)))
     ...
     */
    public async getResourcesInTeam (teamId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericResourceTeamMembers;  }> {
        const localVarPath = this.basePath + '/teams/{teamId}/generic-resources'
            .replace('{' + 'teamId' + '}', encodeURIComponent(String(teamId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GenericResourceTeamMembers;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "GenericResourceTeamMembers");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param resourceId An id that uniquely identifies the Generic Resource
     */
    public async removeGenericResourceFromTeam (teamId: number, resourceId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/teams/{teamId}/generic-resources/{resourceId}'
            .replace('{' + 'teamId' + '}', encodeURIComponent(String(teamId)))
            .replace('{' + 'resourceId' + '}', encodeURIComponent(String(resourceId)));
        let localVarQueryParameters: any = {};
