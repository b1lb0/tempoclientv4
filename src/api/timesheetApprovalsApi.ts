...
import { TimesheetApprovalInput } from '../model/timesheetApprovalInput';
import { TimesheetApprovalResults } from '../model/timesheetApprovalResults';
...
export enum TimesheetApprovalsApiApiKeys {
}

export class TimesheetApprovalsApi {
    ...
    public setApiKey(key: TimesheetApprovalsApiApiKeys, value: string) {
        (this.authentications as any)[TimesheetApprovalsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param timesheetApprovalInput 
     */
    public async approveTimesheetForUser (accountId: string, from: string, to?: string, timesheetApprovalInput?: TimesheetApprovalInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TimesheetApproval;  }> {
        const localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/approve'
        ...
        if (accountId === null || accountId === undefined) {
            throw new Error('Required parameter accountId was null or undefined when calling approveTimesheetForUser.');
        }

        // verify required parameter 'from' is not null or undefined
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling approveTimesheetForUser.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(timesheetApprovalInput, "TimesheetApprovalInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TimesheetApproval;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TimesheetApproval");
     ...
     * @param to The End Date in format yyyy-mm-dd
     */
    public async getTimesheetApprovalForTeam (teamId: string, from: string, to?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TimesheetApprovalResults;  }> {
        const localVarPath = this.basePath + '/timesheet-approvals/team/{teamId}'
        ...
        if (teamId === null || teamId === undefined) {
            throw new Error('Required parameter teamId was null or undefined when calling getTimesheetApprovalForTeam.');
        }

        // verify required parameter 'from' is not null or undefined
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling getTimesheetApprovalForTeam.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TimesheetApprovalResults;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TimesheetApprovalResults");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param to The End Date in format yyyy-mm-dd
     */
    public async getTimesheetApprovalForUser (accountId: string, from: string, to?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TimesheetApproval;  }> {
        const localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}'
            .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'accountId' is not null or undefined
        if (accountId === null || accountId === undefined) {
            throw new Error('Required parameter accountId was null or undefined when calling getTimesheetApprovalForUser.');
        }

        // verify required parameter 'from' is not null or undefined
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling getTimesheetApprovalForUser.');
        }
     ...
     */
    public async getTimesheetApprovalsWaitingForApproval (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TimesheetApprovalResults;  }> {
        const localVarPath = this.basePath + '/timesheet-approvals/waiting';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     * @param accountId 
     */
    public async getTimesheetReviewersForUser (accountId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserResults;  }> {
        const localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/reviewers'
            .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'accountId' is not null or undefined
        if (accountId === null || accountId === undefined) {
            throw new Error('Required parameter accountId was null or undefined when calling getTimesheetReviewersForUser.');
        }
     ...
     * @param timesheetApprovalInput 
     */
    public async rejectTimesheetForUser (accountId: string, from: string, to?: string, timesheetApprovalInput?: TimesheetApprovalInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TimesheetApproval;  }> {
        const localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/reject'
            .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'accountId' is not null or undefined
        if (accountId === null || accountId === undefined) {
            throw new Error('Required parameter accountId was null or undefined when calling rejectTimesheetForUser.');
        }

        // verify required parameter 'from' is not null or undefined
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling rejectTimesheetForUser.');
        }
     ...
     * @param timesheetApprovalInput 
     */
    public async reopenTimesheetForUser (accountId: string, from: string, to?: string, timesheetApprovalInput?: TimesheetApprovalInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TimesheetApproval;  }> {
        const localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/reopen'
            .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'accountId' is not null or undefined
        if (accountId === null || accountId === undefined) {
            throw new Error('Required parameter accountId was null or undefined when calling reopenTimesheetForUser.');
        }

        // verify required parameter 'from' is not null or undefined
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling reopenTimesheetForUser.');
        }
     ...
     * @param timesheetApprovalInput 
     */
    public async submitTimesheetForUser (accountId: string, from: string, to?: string, timesheetApprovalInput?: TimesheetApprovalInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TimesheetApproval;  }> {
        const localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/submit'
            .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'accountId' is not null or undefined
        if (accountId === null || accountId === undefined) {
            throw new Error('Required parameter accountId was null or undefined when calling submitTimesheetForUser.');
        }

        // verify required parameter 'from' is not null or undefined
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling submitTimesheetForUser.');
        }
