...
import { PageablePermissionRole } from '../model/pageablePermissionRole';
import { PermissionRole } from '../model/permissionRole';
import { PermissionRoleInput } from '../model/permissionRoleInput';
...
export enum PermissionRolesApiApiKeys {
}

export class PermissionRolesApi {
    ...
    public setApiKey(key: PermissionRolesApiApiKeys, value: string) {
        (this.authentications as any)[PermissionRolesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createPermissionGroup (permissionRoleInput?: PermissionRoleInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PermissionRole;  }> {
        const localVarPath = this.basePath + '/permission-roles';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(permissionRoleInput, "PermissionRoleInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PermissionRole;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PermissionRole");
     ...
     * @param id 
     */
    public async deleteEditablePermissionGroup (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/permission-roles/{id}'
     ...
     */
    public async getGlobalPermissionRoles (offset?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageablePermissionRole;  }> {
        const localVarPath = this.basePath + '/permission-roles/global';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PageablePermissionRole;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PageablePermissionRole");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getPermissionRole (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PermissionRole;  }> {
        const localVarPath = this.basePath + '/permission-roles/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getPermissionRoles (offset?: number, limit?: number, teamId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageablePermissionRole;  }> {
        const localVarPath = this.basePath + '/permission-roles';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param permissionRoleInput 
     */
    public async updatePermissionGroup (id: number, permissionRoleInput?: PermissionRoleInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PermissionRole;  }> {
        const localVarPath = this.basePath + '/permission-roles/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
