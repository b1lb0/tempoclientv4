...
import { CreateWorkAttributeInput } from '../model/createWorkAttributeInput';
import { PageableWorkAttribute } from '../model/pageableWorkAttribute';
import { UpdateWorkAttributeInput } from '../model/updateWorkAttributeInput';
import { WorkAttribute } from '../model/workAttribute';
...
export enum WorkAttributesApiApiKeys {
}

export class WorkAttributesApi {
    ...
    public setApiKey(key: WorkAttributesApiApiKeys, value: string) {
        (this.authentications as any)[WorkAttributesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param createWorkAttributeInput 
     */
    public async createWorkAttributes (createWorkAttributeInput?: CreateWorkAttributeInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkAttribute;  }> {
        const localVarPath = this.basePath + '/work-attributes';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createWorkAttributeInput, "CreateWorkAttributeInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WorkAttribute;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "WorkAttribute");
     ...
     * @param key 
     */
    public async deleteWorkAttributeByKey (key: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/work-attributes/{key}'
        ...
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling deleteWorkAttributeByKey.');
        }
     ...
     * @param key 
     */
    public async getWorkAttributeByKey (key: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkAttribute;  }> {
        const localVarPath = this.basePath + '/work-attributes/{key}'
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling getWorkAttributeByKey.');
        }
     ...
     */
    public async getWorkAttributes (offset?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageableWorkAttribute;  }> {
        const localVarPath = this.basePath + '/work-attributes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PageableWorkAttribute;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PageableWorkAttribute");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param key 
     * @param updateWorkAttributeInput 
     */
    public async updateWorkAttributeByKey (key: string, updateWorkAttributeInput?: UpdateWorkAttributeInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkAttribute;  }> {
        const localVarPath = this.basePath + '/work-attributes/{key}'
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling updateWorkAttributeByKey.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateWorkAttributeInput, "UpdateWorkAttributeInput")
        };
