...
import { AccountLinkInput } from '../model/accountLinkInput';
import { AccountLinkResults } from '../model/accountLinkResults';
...
export enum AccountLinksApiApiKeys {
}
...
export class AccountLinksApi {
    ...
    public setApiKey(key: AccountLinksApiApiKeys, value: string) {
        (this.authentications as any)[AccountLinksApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createLink (accountLinkInput?: AccountLinkInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountLink;  }> {
        const localVarPath = this.basePath + '/account-links';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(accountLinkInput, "AccountLinkInput")
        };
     ...
     */
    public async deleteLink (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/account-links/{id}'
     ...
     * @param id An integer uniquely identifying the &#x60;AccountLink&#x60;
     */
    public async getLink (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountLink;  }> {
        const localVarPath = this.basePath + '/account-links/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getLinksByProject (id: number, includeGlobalAccounts?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountLinkResults;  }> {
        const localVarPath = this.basePath + '/account-links/project/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (includeGlobalAccounts !== undefined) {
            localVarQueryParameters['includeGlobalAccounts'] = ObjectSerializer.serialize(includeGlobalAccounts, "boolean");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AccountLinkResults;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "AccountLinkResults");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param id An integer uniquely identifying the &#x60;AccountLink&#x60;
     */
    public async patchLink (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/account-links/{id}/make-default'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
