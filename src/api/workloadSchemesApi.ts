...
export enum WorkloadSchemesApiApiKeys {
}

export class WorkloadSchemesApi {
    ...
    public setApiKey(key: WorkloadSchemesApiApiKeys, value: string) {
        (this.authentications as any)[WorkloadSchemesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createWorkloadScheme (workloadSchemeInput?: WorkloadSchemeInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkloadScheme;  }> {
        const localVarPath = this.basePath + '/workload-schemes';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(workloadSchemeInput, "WorkloadSchemeInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WorkloadScheme;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "WorkloadScheme");
     ...
     */
    public async deleteWorkloadScheme (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/workload-schemes/{id}'
     ...
     */
    public async getUserWorkloadScheme (accountId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkloadScheme;  }> {
        const localVarPath = this.basePath + '/workload-schemes/users/{accountId}'
     ...
     * @param id ID of the workload scheme
     */
    public async getWorkloadSchemeById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkloadScheme;  }> {
        const localVarPath = this.basePath + '/workload-schemes/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getWorkloadSchemeMembers1 (id: string, offset?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageableUser;  }> {
        const localVarPath = this.basePath + '/workload-schemes/{id}/members'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param limit Limit the number of elements on the response
     */
    public async getWorkloadSchemes (offset?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageableWorkloadScheme;  }> {
        const localVarPath = this.basePath + '/workload-schemes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PageableWorkloadScheme;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PageableWorkloadScheme");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param id ID of the workload scheme
     */
    public async setDefaultWorkloadScheme (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkloadScheme;  }> {
        const localVarPath = this.basePath + '/workload-schemes/{id}/default'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     */
    public async setWorkloadSchemeForUsers (id: string, workloadSchemeMembersInput?: WorkloadSchemeMembersInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/workload-schemes/{id}/members'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(workloadSchemeMembersInput, "WorkloadSchemeMembersInput")
        };
     ...
     * @param workloadSchemeInput 
     */
    public async updateWorkloadScheme (id: string, workloadSchemeInput?: WorkloadSchemeInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkloadScheme;  }> {
        const localVarPath = this.basePath + '/workload-schemes/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
