...
exports.PermissionRoleInput = void 0;
var PermissionRoleInput = /** @class */ (function () {
    function PermissionRoleInput() {
    }
    PermissionRoleInput.getAttributeTypeMap = function () {
        return PermissionRoleInput.attributeTypeMap;
    };
    PermissionRoleInput.discriminator = undefined;
    PermissionRoleInput.attributeTypeMap = [
        {
            "name": "accessEntityIds",
            "baseName": "accessEntityIds",
            "type": "Array<number>"
        },
        {
            "name": "accessType",
            "baseName": "accessType",
            "type": "PermissionRoleInput.AccessTypeEnum"
        },
        {
            "name": "name",
            "baseName": "name",
        ...
        {
            "name": "permissionKeys",
            "baseName": "permissionKeys",
            "type": "Array<string>"
        },
        {
            "name": "permittedAccountIds",
            "baseName": "permittedAccountIds",
            "type": "Array<string>"
        }
    ];
    return PermissionRoleInput;
}());
exports.PermissionRoleInput = PermissionRoleInput;
(function (PermissionRoleInput) {
    var AccessTypeEnum;
    (function (AccessTypeEnum) {
        AccessTypeEnum[AccessTypeEnum["Team"] = 'TEAM'] = "Team";
        AccessTypeEnum[AccessTypeEnum["Global"] = 'GLOBAL'] = "Global";
    })(AccessTypeEnum = PermissionRoleInput.AccessTypeEnum || (PermissionRoleInput.AccessTypeEnum = {}));
})(PermissionRoleInput || (exports.PermissionRoleInput = PermissionRoleInput = {}));
