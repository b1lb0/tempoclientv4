...
exports.WorklogUpdate = void 0;
var WorklogUpdate = /** @class */ (function () {
    function WorklogUpdate() {
    }
    WorklogUpdate.getAttributeTypeMap = function () {
        return WorklogUpdate.attributeTypeMap;
    };
    WorklogUpdate.discriminator = undefined;
    WorklogUpdate.attributeTypeMap = [
        {
            "name": "attributes",
            "baseName": "attributes",
            "type": "Set<WorkAttributeValueInput>"
        },
        {
            "name": "authorAccountId",
            "baseName": "authorAccountId",
            "type": "string"
        },
        {
            "name": "billableSeconds",
            "baseName": "billableSeconds",
            "type": "number"
        },
        {
            "name": "description",
        ...
        },
        {
            ...
            "baseName": "remainingEstimateSeconds",
            "type": "number"
        },
        {
            "name": "startDate",
    ...
    return WorklogUpdate;
}());
exports.WorklogUpdate = WorklogUpdate;
