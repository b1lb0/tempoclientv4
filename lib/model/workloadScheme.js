...
exports.WorkloadScheme = void 0;
var WorkloadScheme = /** @class */ (function () {
    function WorkloadScheme() {
    }
    WorkloadScheme.getAttributeTypeMap = function () {
        return WorkloadScheme.attributeTypeMap;
    };
    WorkloadScheme.discriminator = undefined;
    WorkloadScheme.attributeTypeMap = [
        {
            "name": "days",
            "baseName": "days",
            "type": "Array<WorkloadSchemeDay>"
        },
        {
            "name": "defaultScheme",
            "baseName": "defaultScheme",
            "type": "boolean"
        },
        {
            "name": "description",
...
exports.WorkloadScheme = WorkloadScheme;
