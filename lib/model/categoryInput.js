...
var CategoryInput = /** @class */ (function () {
    ...
    CategoryInput.getAttributeTypeMap = function () {
        return CategoryInput.attributeTypeMap;
    };
    CategoryInput.discriminator = undefined;
    CategoryInput.attributeTypeMap = [
        {
            "name": "key",
            "baseName": "key",
            "type": "string"
        ...
        },
        {
            "name": "typeName",
            "baseName": "typeName",
            "type": "CategoryInput.TypeNameEnum"
        }
    ];
...
(function (CategoryInput) {
    ...
    (function (TypeNameEnum) {
        TypeNameEnum[TypeNameEnum["Billable"] = 'BILLABLE'] = "Billable";
        TypeNameEnum[TypeNameEnum["Capitalized"] = 'CAPITALIZED'] = "Capitalized";
        TypeNameEnum[TypeNameEnum["Internal"] = 'INTERNAL'] = "Internal";
        TypeNameEnum[TypeNameEnum["Operational"] = 'OPERATIONAL'] = "Operational";
    })(TypeNameEnum = CategoryInput.TypeNameEnum || (CategoryInput.TypeNameEnum = {}));
