...
exports.AccountLinkInput = void 0;
var AccountLinkInput = /** @class */ (function () {
    function AccountLinkInput() {
    }
    AccountLinkInput.getAttributeTypeMap = function () {
        return AccountLinkInput.attributeTypeMap;
    };
    AccountLinkInput.discriminator = undefined;
    AccountLinkInput.attributeTypeMap = [
        {
            "name": "accountKey",
            "baseName": "accountKey",
            "type": "string"
        ...
        },
        {
            "name": "scopeType",
            "baseName": "scopeType",
            "type": "AccountLinkInput.ScopeTypeEnum"
        }
    ];
    return AccountLinkInput;
}());
exports.AccountLinkInput = AccountLinkInput;
(function (AccountLinkInput) {
    var ScopeTypeEnum;
    (function (ScopeTypeEnum) {
        ScopeTypeEnum[ScopeTypeEnum["Project"] = 'PROJECT'] = "Project";
    })(ScopeTypeEnum = AccountLinkInput.ScopeTypeEnum || (AccountLinkInput.ScopeTypeEnum = {}));
})(AccountLinkInput || (exports.AccountLinkInput = AccountLinkInput = {}));
