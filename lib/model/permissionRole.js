...
var PermissionRole = /** @class */ (function () {
    function PermissionRole() {
    }
    PermissionRole.getAttributeTypeMap = function () {
        return PermissionRole.attributeTypeMap;
    };
    PermissionRole.discriminator = undefined;
    PermissionRole.attributeTypeMap = [
        {
            "name": "accessEntities",
            "baseName": "accessEntities",
            "type": "Array<Entity>"
        },
        {
            "name": "accessType",
            "baseName": "accessType",
            "type": "PermissionRole.AccessTypeEnum"
        },
        {
            "name": "editable",
            "baseName": "editable",
...
(function (PermissionRole) {
    ...
    })(AccessTypeEnum = PermissionRole.AccessTypeEnum || (PermissionRole.AccessTypeEnum = {}));
