...
exports.AccountLinkScope = void 0;
/**
* Link to the scope of the `AccountLink`
*/
var AccountLinkScope = /** @class */ (function () {
    function AccountLinkScope() {
    }
    AccountLinkScope.getAttributeTypeMap = function () {
        return AccountLinkScope.attributeTypeMap;
    };
    AccountLinkScope.discriminator = undefined;
    AccountLinkScope.attributeTypeMap = [
        {
            "name": "id",
            "baseName": "id",
            "type": "number"
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "AccountLinkScope.TypeEnum"
        }
    ];
    return AccountLinkScope;
}());
exports.AccountLinkScope = AccountLinkScope;
(function (AccountLinkScope) {
    var TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["Project"] = 'PROJECT'] = "Project";
    })(TypeEnum = AccountLinkScope.TypeEnum || (AccountLinkScope.TypeEnum = {}));
})(AccountLinkScope || (exports.AccountLinkScope = AccountLinkScope = {}));
