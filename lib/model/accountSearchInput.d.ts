 ...
 */
export declare class AccountSearchInput {
    /**
    ...
    */
    'statuses'?: AccountSearchInput.StatusesEnum;
...
export declare namespace AccountSearchInput {
    enum StatusesEnum {
        Open,
        Closed,
        Archived
...
//# sourceMappingURL=accountSearchInput.d.ts.map