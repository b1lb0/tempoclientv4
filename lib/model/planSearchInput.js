...
exports.PlanSearchInput = void 0;
var PlanSearchInput = /** @class */ (function () {
    function PlanSearchInput() {
    }
    PlanSearchInput.getAttributeTypeMap = function () {
        return PlanSearchInput.attributeTypeMap;
    };
    PlanSearchInput.discriminator = undefined;
    PlanSearchInput.attributeTypeMap = [
        {
            "name": "accountIds",
            "baseName": "accountIds",
            "type": "Array<string>"
        ...
        {
            "name": "assigneeTypes",
            "baseName": "assigneeTypes",
            "type": "PlanSearchInput.AssigneeTypesEnum"
        },
        {
            "name": "from",
            "baseName": "from",
        ...
        {
            "name": "planItemIds",
            "baseName": "planItemIds",
            "type": "Array<number>"
        },
        {
            "name": "planItemTypes",
            "baseName": "planItemTypes",
            "type": "PlanSearchInput.PlanItemTypesEnum"
        },
        {
            "name": "plannedTimeBreakdown",
            "baseName": "plannedTimeBreakdown",
            "type": "PlanSearchInput.PlannedTimeBreakdownEnum"
        },
        {
            "name": "to",
            "baseName": "to",
...
exports.PlanSearchInput = PlanSearchInput;
(function (PlanSearchInput) {
    var AssigneeTypesEnum;
    (function (AssigneeTypesEnum) {
        AssigneeTypesEnum[AssigneeTypesEnum["User"] = 'USER'] = "User";
        AssigneeTypesEnum[AssigneeTypesEnum["Generic"] = 'GENERIC'] = "Generic";
    })(AssigneeTypesEnum = PlanSearchInput.AssigneeTypesEnum || (PlanSearchInput.AssigneeTypesEnum = {}));
    var PlanItemTypesEnum;
    (function (PlanItemTypesEnum) {
        PlanItemTypesEnum[PlanItemTypesEnum["Issue"] = 'ISSUE'] = "Issue";
        PlanItemTypesEnum[PlanItemTypesEnum["Project"] = 'PROJECT'] = "Project";
    })(PlanItemTypesEnum = PlanSearchInput.PlanItemTypesEnum || (PlanSearchInput.PlanItemTypesEnum = {}));
    var PlannedTimeBreakdownEnum;
    (function (PlannedTimeBreakdownEnum) {
        PlannedTimeBreakdownEnum[PlannedTimeBreakdownEnum["Daily"] = 'DAILY'] = "Daily";
        PlannedTimeBreakdownEnum[PlannedTimeBreakdownEnum["Period"] = 'PERIOD'] = "Period";
    })(PlannedTimeBreakdownEnum = PlanSearchInput.PlannedTimeBreakdownEnum || (PlanSearchInput.PlannedTimeBreakdownEnum = {}));
})(PlanSearchInput || (exports.PlanSearchInput = PlanSearchInput = {}));
