 ...
 */
export declare class PlanSearchInput {
    /**
...
export declare namespace PlanSearchInput {
    enum AssigneeTypesEnum {
        User,
        Generic
    }
    enum PlanItemTypesEnum {
        Issue,
        Project
    }
    enum PlannedTimeBreakdownEnum {
        Daily,
        Period
    }
}
//# sourceMappingURL=planSearchInput.d.ts.map