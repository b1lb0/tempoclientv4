...
var DaySchedule = /** @class */ (function () {
    function DaySchedule() {
    }
    DaySchedule.getAttributeTypeMap = function () {
        return DaySchedule.attributeTypeMap;
    };
    DaySchedule.discriminator = undefined;
    DaySchedule.attributeTypeMap = [
        {
            "name": "date",
            "baseName": "date",
            "type": "string"
        ...
        },
        {
            ...
            "baseName": "requiredSeconds",
            "type": "number"
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "DaySchedule.TypeEnum"
        }
    ];
    return DaySchedule;
}());
...
(function (DaySchedule) {
    var TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["WorkingDay"] = 'WORKING_DAY'] = "WorkingDay";
        TypeEnum[TypeEnum["NonWorkingDay"] = 'NON_WORKING_DAY'] = "NonWorkingDay";
        TypeEnum[TypeEnum["Holiday"] = 'HOLIDAY'] = "Holiday";
        TypeEnum[TypeEnum["HolidayAndNonWorkingDay"] = 'HOLIDAY_AND_NON_WORKING_DAY'] = "HolidayAndNonWorkingDay";
    })(TypeEnum = DaySchedule.TypeEnum || (DaySchedule.TypeEnum = {}));
})(DaySchedule || (exports.DaySchedule = DaySchedule = {}));
