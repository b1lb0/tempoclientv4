...
exports.PlanInput = void 0;
var PlanInput = /** @class */ (function () {
    function PlanInput() {
    }
    PlanInput.getAttributeTypeMap = function () {
        return PlanInput.attributeTypeMap;
    };
    PlanInput.discriminator = undefined;
    PlanInput.attributeTypeMap = [
        {
            "name": "assigneeId",
            "baseName": "assigneeId",
            "type": "string"
        },
        {
            ...
            "type": "PlanInput.AssigneeTypeEnum"
        },
        {
            "name": "description",
        ...
        {
            "name": "effortPersistenceType",
            "baseName": "effortPersistenceType",
            "type": "PlanInput.EffortPersistenceTypeEnum"
        },
        {
            "name": "endDate",
            "baseName": "endDate",
        ...
        {
            "name": "includeNonWorkingDays",
            "baseName": "includeNonWorkingDays",
            "type": "boolean"
        },
        {
            "name": "planApproval",
            "baseName": "planApproval",
        ...
        {
            "name": "planItemType",
            "baseName": "planItemType",
            "type": "PlanInput.PlanItemTypeEnum"
        },
        {
            "name": "plannedSeconds",
            "baseName": "plannedSeconds",
            "type": "number"
        },
        {
            "name": "plannedSecondsPerDay",
            "baseName": "plannedSecondsPerDay",
            "type": "number"
        },
        {
            "name": "recurrenceEndDate",
            "baseName": "recurrenceEndDate",
            "type": "string"
        },
        {
            "name": "rule",
            "baseName": "rule",
            "type": "PlanInput.RuleEnum"
        },
        {
            "name": "startDate",
            "baseName": "startDate",
...
exports.PlanInput = PlanInput;
(function (PlanInput) {
    var AssigneeTypeEnum;
    (function (AssigneeTypeEnum) {
        AssigneeTypeEnum[AssigneeTypeEnum["User"] = 'USER'] = "User";
        AssigneeTypeEnum[AssigneeTypeEnum["Generic"] = 'GENERIC'] = "Generic";
    })(AssigneeTypeEnum = PlanInput.AssigneeTypeEnum || (PlanInput.AssigneeTypeEnum = {}));
    var EffortPersistenceTypeEnum;
    (function (EffortPersistenceTypeEnum) {
        EffortPersistenceTypeEnum[EffortPersistenceTypeEnum["SecondsPerDay"] = 'SECONDS_PER_DAY'] = "SecondsPerDay";
        EffortPersistenceTypeEnum[EffortPersistenceTypeEnum["TotalSeconds"] = 'TOTAL_SECONDS'] = "TotalSeconds";
    })(EffortPersistenceTypeEnum = PlanInput.EffortPersistenceTypeEnum || (PlanInput.EffortPersistenceTypeEnum = {}));
    var PlanItemTypeEnum;
    (function (PlanItemTypeEnum) {
        PlanItemTypeEnum[PlanItemTypeEnum["Issue"] = 'ISSUE'] = "Issue";
        PlanItemTypeEnum[PlanItemTypeEnum["Project"] = 'PROJECT'] = "Project";
    })(PlanItemTypeEnum = PlanInput.PlanItemTypeEnum || (PlanInput.PlanItemTypeEnum = {}));
    var RuleEnum;
    (function (RuleEnum) {
        RuleEnum[RuleEnum["Never"] = 'NEVER'] = "Never";
        RuleEnum[RuleEnum["Weekly"] = 'WEEKLY'] = "Weekly";
        RuleEnum[RuleEnum["BiWeekly"] = 'BI_WEEKLY'] = "BiWeekly";
        RuleEnum[RuleEnum["Monthly"] = 'MONTHLY'] = "Monthly";
    })(RuleEnum = PlanInput.RuleEnum || (PlanInput.RuleEnum = {}));
})(PlanInput || (exports.PlanInput = PlanInput = {}));
