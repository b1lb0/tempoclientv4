...
exports.WorkloadSchemeDayInput = void 0;
/**
...
*/
var WorkloadSchemeDayInput = /** @class */ (function () {
    function WorkloadSchemeDayInput() {
    }
    WorkloadSchemeDayInput.getAttributeTypeMap = function () {
        return WorkloadSchemeDayInput.attributeTypeMap;
    };
    WorkloadSchemeDayInput.discriminator = undefined;
    WorkloadSchemeDayInput.attributeTypeMap = [
        {
            "name": "day",
            "baseName": "day",
            "type": "WorkloadSchemeDayInput.DayEnum"
        },
        {
...
exports.WorkloadSchemeDayInput = WorkloadSchemeDayInput;
(function (WorkloadSchemeDayInput) {
    var DayEnum;
    (function (DayEnum) {
    ...
    })(DayEnum = WorkloadSchemeDayInput.DayEnum || (WorkloadSchemeDayInput.DayEnum = {}));
})(WorkloadSchemeDayInput || (exports.WorkloadSchemeDayInput = WorkloadSchemeDayInput = {}));
