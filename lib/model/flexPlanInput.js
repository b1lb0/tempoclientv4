...
exports.FlexPlanInput = void 0;
var FlexPlanInput = /** @class */ (function () {
    function FlexPlanInput() {
    }
    FlexPlanInput.getAttributeTypeMap = function () {
        return FlexPlanInput.attributeTypeMap;
    };
    FlexPlanInput.discriminator = undefined;
    FlexPlanInput.attributeTypeMap = [
        {
            "name": "description",
    ...
    return FlexPlanInput;
}());
exports.FlexPlanInput = FlexPlanInput;
