...
exports.GenericResourceTeamMember = void 0;
var GenericResourceTeamMember = /** @class */ (function () {
    function GenericResourceTeamMember() {
    }
    GenericResourceTeamMember.getAttributeTypeMap = function () {
        return GenericResourceTeamMember.attributeTypeMap;
    };
    GenericResourceTeamMember.discriminator = undefined;
    GenericResourceTeamMember.attributeTypeMap = [
        {
            "name": "assignedToTeamAt",
            "baseName": "assignedToTeamAt",
            "type": "string"
        },
        {
            "name": "assignedToTeamBy",
            "baseName": "assignedToTeamBy",
            "type": "UserRefBean"
        },
        {
            "name": "member",
            "baseName": "member",
            "type": "GenericResourceReference"
        },
        {
            "name": "self",
            "baseName": "self",
...
exports.GenericResourceTeamMember = GenericResourceTeamMember;
