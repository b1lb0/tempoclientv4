...
exports.TeamLinkScope = void 0;
/**
* The team scope
*/
var TeamLinkScope = /** @class */ (function () {
    function TeamLinkScope() {
    }
    TeamLinkScope.getAttributeTypeMap = function () {
        return TeamLinkScope.attributeTypeMap;
    };
    TeamLinkScope.discriminator = undefined;
    TeamLinkScope.attributeTypeMap = [
        {
            "name": "id",
            "baseName": "id",
            "type": "number"
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "TeamLinkScope.TypeEnum"
        }
    ];
    return TeamLinkScope;
}());
exports.TeamLinkScope = TeamLinkScope;
(function (TeamLinkScope) {
    var TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["Board"] = 'BOARD'] = "Board";
        TypeEnum[TypeEnum["Project"] = 'PROJECT'] = "Project";
    })(TypeEnum = TeamLinkScope.TypeEnum || (TeamLinkScope.TypeEnum = {}));
})(TeamLinkScope || (exports.TeamLinkScope = TeamLinkScope = {}));
