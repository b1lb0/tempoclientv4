...
exports.SearchOrderBean = void 0;
/**
...
*/
var SearchOrderBean = /** @class */ (function () {
    function SearchOrderBean() {
    }
    SearchOrderBean.getAttributeTypeMap = function () {
        return SearchOrderBean.attributeTypeMap;
    };
    SearchOrderBean.discriminator = undefined;
    SearchOrderBean.attributeTypeMap = [
        {
            "name": "field",
            "baseName": "field",
            "type": "SearchOrderBean.FieldEnum"
        },
        {
            "name": "order",
            "baseName": "order",
            "type": "SearchOrderBean.OrderEnum"
        }
    ];
    return SearchOrderBean;
}());
exports.SearchOrderBean = SearchOrderBean;
(function (SearchOrderBean) {
    var FieldEnum;
    (function (FieldEnum) {
        FieldEnum[FieldEnum["Id"] = 'ID'] = "Id";
        FieldEnum[FieldEnum["StartDateTime"] = 'START_DATE_TIME'] = "StartDateTime";
        FieldEnum[FieldEnum["Updated"] = 'UPDATED'] = "Updated";
    })(FieldEnum = SearchOrderBean.FieldEnum || (SearchOrderBean.FieldEnum = {}));
    var OrderEnum;
    (function (OrderEnum) {
        OrderEnum[OrderEnum["Asc"] = 'ASC'] = "Asc";
        OrderEnum[OrderEnum["Desc"] = 'DESC'] = "Desc";
    })(OrderEnum = SearchOrderBean.OrderEnum || (SearchOrderBean.OrderEnum = {}));
})(SearchOrderBean || (exports.SearchOrderBean = SearchOrderBean = {}));
