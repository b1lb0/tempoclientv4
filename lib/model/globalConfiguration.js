...
var GlobalConfiguration = /** @class */ (function () {
    ...
    GlobalConfiguration.getAttributeTypeMap = function () {
        return GlobalConfiguration.attributeTypeMap;
    };
    GlobalConfiguration.discriminator = undefined;
    GlobalConfiguration.attributeTypeMap = [
        {
            "name": "allowLoggingOnClosedAccount",
            "baseName": "allowLoggingOnClosedAccount",
            "type": "boolean"
        },
        {
            "name": "approvalPeriod",
            "baseName": "approvalPeriod",
            "type": "GlobalConfiguration.ApprovalPeriodEnum"
        },
        {
            "name": "approvalWeekStart",
            "baseName": "approvalWeekStart",
            "type": "number"
        },
        {
            "name": "maxHoursPerDayPerUser",
            "baseName": "maxHoursPerDayPerUser",
            "type": "number"
        },
        {
            "name": "numberOfDaysAllowedIntoFuture",
            "baseName": "numberOfDaysAllowedIntoFuture",
            "type": "number"
        },
        {
            "name": "planApprovalEnabled",
            "baseName": "planApprovalEnabled",
            "type": "boolean"
        },
        {
            "name": "remainingEstimateOptional",
            "baseName": "remainingEstimateOptional",
            "type": "boolean"
        },
        {
            "name": "startAndEndTimesEnabled",
            "baseName": "startAndEndTimesEnabled",
            "type": "boolean"
        },
        {
            "name": "startAndEndTimesForPlanningEnabled",
            "baseName": "startAndEndTimesForPlanningEnabled",
            "type": "boolean"
        },
        {
            "name": "weekStart",
        ...
        {
            "name": "worklogDescriptionOptional",
            "baseName": "worklogDescriptionOptional",
            "type": "boolean"
        }
    ];
...
(function (GlobalConfiguration) {
    var ApprovalPeriodEnum;
    (function (ApprovalPeriodEnum) {
        ApprovalPeriodEnum[ApprovalPeriodEnum["Week"] = 'WEEK'] = "Week";
        ApprovalPeriodEnum[ApprovalPeriodEnum["Month"] = 'MONTH'] = "Month";
    })(ApprovalPeriodEnum = GlobalConfiguration.ApprovalPeriodEnum || (GlobalConfiguration.ApprovalPeriodEnum = {}));
})(GlobalConfiguration || (exports.GlobalConfiguration = GlobalConfiguration = {}));
