...
exports.TeamInput = void 0;
var TeamInput = /** @class */ (function () {
    function TeamInput() {
        /**
    ...
    TeamInput.getAttributeTypeMap = function () {
        return TeamInput.attributeTypeMap;
    };
    TeamInput.discriminator = undefined;
    TeamInput.attributeTypeMap = [
        {
            "name": "administrative",
