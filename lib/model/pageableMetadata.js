...
exports.PageableMetadata = void 0;
var PageableMetadata = /** @class */ (function () {
    function PageableMetadata() {
    }
    PageableMetadata.getAttributeTypeMap = function () {
        return PageableMetadata.attributeTypeMap;
    };
    PageableMetadata.discriminator = undefined;
    PageableMetadata.attributeTypeMap = [
        {
            "name": "count",
            "baseName": "count",
            "type": "number"
...
exports.PageableMetadata = PageableMetadata;
