...
exports.FlexPlan = void 0;
var FlexPlan = /** @class */ (function () {
    function FlexPlan() {
    }
    FlexPlan.getAttributeTypeMap = function () {
        return FlexPlan.attributeTypeMap;
    };
    FlexPlan.discriminator = undefined;
    FlexPlan.attributeTypeMap = [
        {
            "name": "description",
