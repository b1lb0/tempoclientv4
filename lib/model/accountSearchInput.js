...
exports.AccountSearchInput = void 0;
var AccountSearchInput = /** @class */ (function () {
    function AccountSearchInput() {
    }
    AccountSearchInput.getAttributeTypeMap = function () {
        return AccountSearchInput.attributeTypeMap;
    };
    AccountSearchInput.discriminator = undefined;
    AccountSearchInput.attributeTypeMap = [
        {
            "name": "global",
            "baseName": "global",
            "type": "boolean"
        ...
        },
        {
            "name": "statuses",
            "baseName": "statuses",
            "type": "AccountSearchInput.StatusesEnum"
        }
    ];
    return AccountSearchInput;
}());
exports.AccountSearchInput = AccountSearchInput;
(function (AccountSearchInput) {
    var StatusesEnum;
    (function (StatusesEnum) {
        StatusesEnum[StatusesEnum["Open"] = 'OPEN'] = "Open";
        StatusesEnum[StatusesEnum["Closed"] = 'CLOSED'] = "Closed";
        StatusesEnum[StatusesEnum["Archived"] = 'ARCHIVED'] = "Archived";
    })(StatusesEnum = AccountSearchInput.StatusesEnum || (AccountSearchInput.StatusesEnum = {}));
})(AccountSearchInput || (exports.AccountSearchInput = AccountSearchInput = {}));
