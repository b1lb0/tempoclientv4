...
exports.FlexPlanSearchInput = void 0;
var FlexPlanSearchInput = /** @class */ (function () {
    function FlexPlanSearchInput() {
    }
    FlexPlanSearchInput.getAttributeTypeMap = function () {
        return FlexPlanSearchInput.attributeTypeMap;
    };
    FlexPlanSearchInput.discriminator = undefined;
    FlexPlanSearchInput.attributeTypeMap = [
        {
            "name": "flexPlanIds",
            "baseName": "flexPlanIds",
            "type": "Array<number>"
        },
        {
            "name": "from",
    ...
    return FlexPlanSearchInput;
}());
exports.FlexPlanSearchInput = FlexPlanSearchInput;
