...
exports.TimesheetApprovalStatus = void 0;
/**
* The current status of this timesheet
*/
var TimesheetApprovalStatus = /** @class */ (function () {
    function TimesheetApprovalStatus() {
    }
    TimesheetApprovalStatus.getAttributeTypeMap = function () {
        return TimesheetApprovalStatus.attributeTypeMap;
    };
    TimesheetApprovalStatus.discriminator = undefined;
    TimesheetApprovalStatus.attributeTypeMap = [
        {
            "name": "actor",
            "baseName": "actor",
        ...
        },
        {
            "name": "key",
            "baseName": "key",
            "type": "TimesheetApprovalStatus.KeyEnum"
        },
        {
            "name": "requiredSecondsAtSubmit",
            "baseName": "requiredSecondsAtSubmit",
            "type": "number"
        },
        {
            "name": "timeSpentSecondsAtSubmit",
            "baseName": "timeSpentSecondsAtSubmit",
            "type": "number"
        },
        {
            "name": "updatedAt",
...
exports.TimesheetApprovalStatus = TimesheetApprovalStatus;
(function (TimesheetApprovalStatus) {
    var KeyEnum;
    (function (KeyEnum) {
        KeyEnum[KeyEnum["Open"] = 'OPEN'] = "Open";
        KeyEnum[KeyEnum["InReview"] = 'IN_REVIEW'] = "InReview";
        KeyEnum[KeyEnum["Approved"] = 'APPROVED'] = "Approved";
    })(KeyEnum = TimesheetApprovalStatus.KeyEnum || (TimesheetApprovalStatus.KeyEnum = {}));
})(TimesheetApprovalStatus || (exports.TimesheetApprovalStatus = TimesheetApprovalStatus = {}));
