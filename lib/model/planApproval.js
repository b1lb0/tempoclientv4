...
exports.PlanApproval = void 0;
/**
* Reference to an approval linked to the `Plan`.
*/
var PlanApproval = /** @class */ (function () {
    function PlanApproval() {
    }
    PlanApproval.getAttributeTypeMap = function () {
        return PlanApproval.attributeTypeMap;
    };
    PlanApproval.discriminator = undefined;
    PlanApproval.attributeTypeMap = [
        {
            "name": "actor",
            "baseName": "actor",
            "type": "User"
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "PlanApproval.StatusEnum"
        }
    ];
    return PlanApproval;
}());
exports.PlanApproval = PlanApproval;
(function (PlanApproval) {
    var StatusEnum;
    (function (StatusEnum) {
    ...
    })(StatusEnum = PlanApproval.StatusEnum || (PlanApproval.StatusEnum = {}));
})(PlanApproval || (exports.PlanApproval = PlanApproval = {}));
