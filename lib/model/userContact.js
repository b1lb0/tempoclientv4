...
var UserContact = /** @class */ (function () {
    ...
    UserContact.getAttributeTypeMap = function () {
        return UserContact.attributeTypeMap;
    };
    UserContact.discriminator = undefined;
    UserContact.attributeTypeMap = [
        {
            "name": "accountId",
            "baseName": "accountId",
            "type": "string"
...
(function (UserContact) {
    ...
    })(TypeEnum = UserContact.TypeEnum || (UserContact.TypeEnum = {}));
})(UserContact || (exports.UserContact = UserContact = {}));
