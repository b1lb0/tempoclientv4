...
exports.HolidayInput = void 0;
var HolidayInput = /** @class */ (function () {
    function HolidayInput() {
    }
    HolidayInput.getAttributeTypeMap = function () {
        return HolidayInput.attributeTypeMap;
    };
    HolidayInput.discriminator = undefined;
    HolidayInput.attributeTypeMap = [
        {
            "name": "date",
            "baseName": "date",
            "type": "string"
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "HolidayInput.TypeEnum"
        }
    ];
    return HolidayInput;
}());
exports.HolidayInput = HolidayInput;
(function (HolidayInput) {
    var TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["Fixed"] = 'FIXED'] = "Fixed";
        TypeEnum[TypeEnum["Floating"] = 'FLOATING'] = "Floating";
    })(TypeEnum = HolidayInput.TypeEnum || (HolidayInput.TypeEnum = {}));
})(HolidayInput || (exports.HolidayInput = HolidayInput = {}));
