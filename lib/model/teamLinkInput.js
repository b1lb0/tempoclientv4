...
exports.TeamLinkInput = void 0;
var TeamLinkInput = /** @class */ (function () {
    function TeamLinkInput() {
    }
    TeamLinkInput.getAttributeTypeMap = function () {
        return TeamLinkInput.attributeTypeMap;
    };
    TeamLinkInput.discriminator = undefined;
    TeamLinkInput.attributeTypeMap = [
        {
            "name": "scopeId",
            "baseName": "scopeId",
            "type": "number"
        },
        {
            "name": "scopeType",
            "baseName": "scopeType",
            "type": "TeamLinkInput.ScopeTypeEnum"
        },
        {
            "name": "teamId",
            "baseName": "teamId",
    ...
    return TeamLinkInput;
}());
exports.TeamLinkInput = TeamLinkInput;
(function (TeamLinkInput) {
    var ScopeTypeEnum;
    (function (ScopeTypeEnum) {
        ScopeTypeEnum[ScopeTypeEnum["Project"] = 'PROJECT'] = "Project";
    })(ScopeTypeEnum = TeamLinkInput.ScopeTypeEnum || (TeamLinkInput.ScopeTypeEnum = {}));
})(TeamLinkInput || (exports.TeamLinkInput = TeamLinkInput = {}));
