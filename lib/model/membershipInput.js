...
exports.MembershipInput = void 0;
var MembershipInput = /** @class */ (function () {
    function MembershipInput() {
    }
    MembershipInput.getAttributeTypeMap = function () {
        return MembershipInput.attributeTypeMap;
    };
    MembershipInput.discriminator = undefined;
    MembershipInput.attributeTypeMap = [
        {
