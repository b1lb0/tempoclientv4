...
exports.WorkloadSchemeDay = void 0;
/**
* The list of days and their required hours in this `WorkloadScheme`
*/
var WorkloadSchemeDay = /** @class */ (function () {
    function WorkloadSchemeDay() {
    }
    WorkloadSchemeDay.getAttributeTypeMap = function () {
        return WorkloadSchemeDay.attributeTypeMap;
    };
    WorkloadSchemeDay.discriminator = undefined;
    WorkloadSchemeDay.attributeTypeMap = [
        {
            "name": "day",
            "baseName": "day",
            "type": "WorkloadSchemeDay.DayEnum"
        },
        {
...
exports.WorkloadSchemeDay = WorkloadSchemeDay;
(function (WorkloadSchemeDay) {
    var DayEnum;
    (function (DayEnum) {
    ...
    })(DayEnum = WorkloadSchemeDay.DayEnum || (WorkloadSchemeDay.DayEnum = {}));
})(WorkloadSchemeDay || (exports.WorkloadSchemeDay = WorkloadSchemeDay = {}));
