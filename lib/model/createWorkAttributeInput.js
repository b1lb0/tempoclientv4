...
exports.CreateWorkAttributeInput = void 0;
var CreateWorkAttributeInput = /** @class */ (function () {
    function CreateWorkAttributeInput() {
    }
    CreateWorkAttributeInput.getAttributeTypeMap = function () {
        return CreateWorkAttributeInput.attributeTypeMap;
    };
    CreateWorkAttributeInput.discriminator = undefined;
    CreateWorkAttributeInput.attributeTypeMap = [
        {
            "name": "key",
            "baseName": "key",
            "type": "string"
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "CreateWorkAttributeInput.TypeEnum"
        },
        {
            "name": "values",
            "baseName": "values",
    ...
    return CreateWorkAttributeInput;
}());
exports.CreateWorkAttributeInput = CreateWorkAttributeInput;
(function (CreateWorkAttributeInput) {
    var TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["Account"] = 'ACCOUNT'] = "Account";
        TypeEnum[TypeEnum["Checkbox"] = 'CHECKBOX'] = "Checkbox";
        TypeEnum[TypeEnum["InputField"] = 'INPUT_FIELD'] = "InputField";
        TypeEnum[TypeEnum["InputNumeric"] = 'INPUT_NUMERIC'] = "InputNumeric";
        TypeEnum[TypeEnum["StaticList"] = 'STATIC_LIST'] = "StaticList";
    })(TypeEnum = CreateWorkAttributeInput.TypeEnum || (CreateWorkAttributeInput.TypeEnum = {}));
})(CreateWorkAttributeInput || (exports.CreateWorkAttributeInput = CreateWorkAttributeInput = {}));
