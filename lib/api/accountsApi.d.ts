...
export declare class AccountsApi {
     ...
     * @param accountInput
     */
    createAccount(accountInput?: AccountInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    deleteAccount(key: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getAccountById(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getAccountLinks(key: string, offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageableAccountLink;
    }>;
    /**
     ...
     * @param limit Limit the number of elements on the response
     */
    getAccounts(offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageableAccount;
    }>;
    /**
     ...
     */
    searchAccounts(offset?: number, limit?: number, accountSearchInput?: AccountSearchInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param accountInput
     */
    updateAccount(key: string, accountInput?: AccountInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
