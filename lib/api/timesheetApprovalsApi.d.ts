...
export declare enum TimesheetApprovalsApiApiKeys {
}
export declare class TimesheetApprovalsApi {
    ...
    setApiKey(key: TimesheetApprovalsApiApiKeys, value: string): void;
     ...
     */
    approveTimesheetForUser(accountId: string, from: string, to?: string, timesheetApprovalInput?: TimesheetApprovalInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param to The End Date in format yyyy-mm-dd
     */
    getTimesheetApprovalForTeam(teamId: string, from: string, to?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: TimesheetApprovalResults;
    }>;
    /**
     ...
     * @param to The End Date in format yyyy-mm-dd
     */
    getTimesheetApprovalForUser(accountId: string, from: string, to?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getTimesheetApprovalsWaitingForApproval(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param accountId
     */
    getTimesheetReviewersForUser(accountId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param timesheetApprovalInput
     */
    rejectTimesheetForUser(accountId: string, from: string, to?: string, timesheetApprovalInput?: TimesheetApprovalInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param timesheetApprovalInput
     */
    reopenTimesheetForUser(accountId: string, from: string, to?: string, timesheetApprovalInput?: TimesheetApprovalInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param timesheetApprovalInput
     */
    submitTimesheetForUser(accountId: string, from: string, to?: string, timesheetApprovalInput?: TimesheetApprovalInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=timesheetApprovalsApi.d.ts.map