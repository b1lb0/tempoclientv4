...
exports.TeamMembershipsApi = exports.TeamMembershipsApiApiKeys = void 0;
...
// ===============================================
var TeamMembershipsApiApiKeys;
(function (TeamMembershipsApiApiKeys) {
})(TeamMembershipsApiApiKeys || (exports.TeamMembershipsApiApiKeys = TeamMembershipsApiApiKeys = {}));
var TeamMembershipsApi = /** @class */ (function () {
    function TeamMembershipsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(TeamMembershipsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(TeamMembershipsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(TeamMembershipsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    TeamMembershipsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    TeamMembershipsApi.prototype.setApiKey = function (key, value) {
        this.authentications[TeamMembershipsApiApiKeys[key]].apiKey = value;
    };
    TeamMembershipsApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    TeamMembershipsApi.prototype.createMembership = function (teamMembershipInput_1) {
        return __awaiter(this, arguments, void 0, function (teamMembershipInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/team-memberships';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(teamMembershipInput, "TeamMembershipInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TeamMembership");
     ...
     * @param id
     */
    TeamMembershipsApi.prototype.deleteMembership = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/team-memberships/{id}'
     ...
     * @param teamId
     */
    TeamMembershipsApi.prototype.getAllMemberships = function (teamId_1) {
        return __awaiter(this, arguments, void 0, function (teamId, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/team-memberships/team/{teamId}'
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TeamMembershipResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param id
     */
    TeamMembershipsApi.prototype.getMembership = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
     ...
     */
    TeamMembershipsApi.prototype.searchMemberships = function (offset_1, limit_1, membershipSearchInput_1) {
        return __awaiter(this, arguments, void 0, function (offset, limit, membershipSearchInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/team-memberships/search';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(membershipSearchInput, "MembershipSearchInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TeamMembershipResultsPageable");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     */
    TeamMembershipsApi.prototype.updateMembership = function (id_1, membershipInput_1) {
        return __awaiter(this, arguments, void 0, function (id, membershipInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(membershipInput, "MembershipInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
