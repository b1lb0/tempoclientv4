...
var ProgramApi = /** @class */ (function () {
    function ProgramApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ProgramApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ProgramApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(ProgramApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    ProgramApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ProgramApi.prototype.setApiKey = function (key, value) {
        this.authentications[ProgramApiApiKeys[key]].apiKey = value;
    };
    ProgramApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param programInput
     */
    ProgramApi.prototype.createProgram = function (programInput_1) {
        return __awaiter(this, arguments, void 0, function (programInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/programs';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(programInput, "ProgramInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "Program");
     ...
     * @param id
     */
    ProgramApi.prototype.deleteProgram = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/programs/{id}'
     ...
     * @param id
     */
    ProgramApi.prototype.getProgramById = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
     ...
     */
    ProgramApi.prototype.getPrograms = function () {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "ProgramResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param id
     */
    ProgramApi.prototype.getTeamsByProgramId = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/programs/{id}/teams'
                    .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TeamRefResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param programInput
     */
    ProgramApi.prototype.updateProgram = function (id_1, programInput_1) {
        return __awaiter(this, arguments, void 0, function (id, programInput, options) {
