...
export declare enum AccountCategoriesApiApiKeys {
    Bearer = "Bearer"
}
export declare class AccountCategoriesApi {
    ...
    setApiKey(key: AccountCategoriesApiApiKeys, value: string): void;
     ...
     * @param categoryInput
     */
    createCategory(categoryInput?: CategoryInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param key
     */
    deleteCategory(key: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id
     */
    getCategories(id?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param key
     */
    getCategoryByKey(key: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param categoryInput
     */
    updateCategory(key: string, categoryInput?: CategoryInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=accountCategoriesApi.d.ts.map