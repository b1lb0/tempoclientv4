...
export declare enum GenericResourcesApiApiKeys {
}
export declare class GenericResourcesApi {
    ...
    setApiKey(key: GenericResourcesApiApiKeys, value: string): void;
     ...
     */
    createGenericResource(genericResourceInput?: GenericResourceInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    deleteGenericResource(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param genericResourceInput
     */
    editGenericResource(id: number, genericResourceInput?: GenericResourceInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id An id that uniquely identifies the Generic Resource
     */
    getGenericResource(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    searchGenericResources(genericResourceSearchInput?: GenericResourceSearchInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageableGenericResourceWithoutSelfLink;
    }>;
}
//# sourceMappingURL=genericResourcesApi.d.ts.map