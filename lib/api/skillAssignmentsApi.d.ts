...
export declare enum SkillAssignmentsApiApiKeys {
}
export declare class SkillAssignmentsApi {
    ...
    setApiKey(key: SkillAssignmentsApiApiKeys, value: string): void;
     ...
     */
    assignSkills(skillsAssignmentInput?: SkillsAssignmentInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getSkillAssignments(assigneeId: string, assigneeType: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    removeSkillAssignment(assigneeId: string, assigneeType: string, skillId: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param skillsAssignmentInput
     */
    replaceSkillAssignments(skillsAssignmentInput?: SkillsAssignmentInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=skillAssignmentsApi.d.ts.map