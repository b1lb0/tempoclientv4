...
exports.CustomersApi = exports.CustomersApiApiKeys = void 0;
...
})(CustomersApiApiKeys || (exports.CustomersApiApiKeys = CustomersApiApiKeys = {}));
var CustomersApi = /** @class */ (function () {
    function CustomersApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(CustomersApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(CustomersApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(CustomersApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    CustomersApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    CustomersApi.prototype.setApiKey = function (key, value) {
        this.authentications[CustomersApiApiKeys[key]].apiKey = value;
    };
    CustomersApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param customerInput
     */
    CustomersApi.prototype.createCustomer = function (customerInput_1) {
        return __awaiter(this, arguments, void 0, function (customerInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/customers';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(customerInput, "CustomerInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "Customer");
     ...
     * @param key
     */
    CustomersApi.prototype.deleteCustomer = function (key_1) {
        return __awaiter(this, arguments, void 0, function (key, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/customers/{key}'
     ...
     */
    CustomersApi.prototype.getCustomerAccounts = function (id_1, offset_1, limit_1) {
        return __awaiter(this, arguments, void 0, function (id, offset, limit, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/customers/{id}/accounts'
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableAccount");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param id
     */
    CustomersApi.prototype.getCustomerById = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/customers/{id}'
                    .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
     ...
     * @param limit Limit the number of elements on the response
     */
    CustomersApi.prototype.getCustomers = function (offset_1, limit_1) {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableCustomer");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     */
    CustomersApi.prototype.searchCustomers = function (offset_1, limit_1, customerSearchInput_1) {
        return __awaiter(this, arguments, void 0, function (offset, limit, customerSearchInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/customers/search';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(customerSearchInput, "CustomerSearchInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
     ...
     * @param customerInput
     */
    CustomersApi.prototype.updateCustomer = function (key_1, customerInput_1) {
        return __awaiter(this, arguments, void 0, function (key, customerInput, options) {
