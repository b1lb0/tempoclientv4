...
})(TeamApiApiKeys || (exports.TeamApiApiKeys = TeamApiApiKeys = {}));
var TeamApi = /** @class */ (function () {
    function TeamApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(TeamApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(TeamApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(TeamApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    TeamApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    TeamApi.prototype.setApiKey = function (key, value) {
        this.authentications[TeamApiApiKeys[key]].apiKey = value;
    };
    TeamApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param teamInput
     */
    TeamApi.prototype.createTeam = function (teamInput_1) {
        return __awaiter(this, arguments, void 0, function (teamInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(teamInput, "TeamInput")
                };
     ...
     */
    TeamApi.prototype.deleteTeam = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/teams/{id}'
     ...
     * @param id An id that uniquely identifies the Team.
     */
    TeamApi.prototype.getTeamById = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
     ...
     */
    TeamApi.prototype.getTeamLinks = function (id_1, offset_1, limit_1) {
        return __awaiter(this, arguments, void 0, function (id, offset, limit, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/teams/{id}/links'
                    .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableTeamLink");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param id
     */
    TeamApi.prototype.getTeamMembers = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/teams/{id}/members'
                    .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableMemberMemberships");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     */
    TeamApi.prototype.getTeams = function (offset_1, limit_1, teamMembers_1, name_1) {
        return __awaiter(this, arguments, void 0, function (offset, limit, teamMembers, name, options) {
            ...
            return __generator(this, function (_b) {
                ...
                if (teamMembers !== undefined) {
                    localVarQueryParameters['teamMembers'] = models_1.ObjectSerializer.serialize(teamMembers, "Array<string>");
                }
                if (name !== undefined) {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableTeam");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param teamInput
     */
    TeamApi.prototype.updateTeam = function (id_1, teamInput_1) {
        return __awaiter(this, arguments, void 0, function (id, teamInput, options) {
