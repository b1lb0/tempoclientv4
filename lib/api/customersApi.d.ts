...
export declare class CustomersApi {
     ...
     * @param customerInput
     */
    createCustomer(customerInput?: CustomerInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param key
     */
    deleteCustomer(key: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getCustomerAccounts(id: number, offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id
     */
    getCustomerById(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param limit Limit the number of elements on the response
     */
    getCustomers(offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageableCustomer;
    }>;
    /**
     ...
     */
    searchCustomers(offset?: number, limit?: number, customerSearchInput?: CustomerSearchInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param customerInput
     */
    updateCustomer(key: string, customerInput?: CustomerInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
