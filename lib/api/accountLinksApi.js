...
exports.AccountLinksApi = exports.AccountLinksApiApiKeys = void 0;
...
// ===============================================
var AccountLinksApiApiKeys;
(function (AccountLinksApiApiKeys) {
})(AccountLinksApiApiKeys || (exports.AccountLinksApiApiKeys = AccountLinksApiApiKeys = {}));
var AccountLinksApi = /** @class */ (function () {
    function AccountLinksApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AccountLinksApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AccountLinksApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(AccountLinksApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    AccountLinksApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AccountLinksApi.prototype.setApiKey = function (key, value) {
        this.authentications[AccountLinksApiApiKeys[key]].apiKey = value;
    };
    AccountLinksApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param accountLinkInput
     */
    AccountLinksApi.prototype.createLink = function (accountLinkInput_1) {
        return __awaiter(this, arguments, void 0, function (accountLinkInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/account-links';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(accountLinkInput, "AccountLinkInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "AccountLink");
     ...
     * @param id An integer uniquely identifying the &#x60;AccountLink&#x60;
     */
    AccountLinksApi.prototype.deleteLink = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/account-links/{id}'
     ...
     * @param id An integer uniquely identifying the &#x60;AccountLink&#x60;
     */
    AccountLinksApi.prototype.getLink = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
     ...
     * @param id
     * @param includeGlobalAccounts
     */
    AccountLinksApi.prototype.getLinksByProject = function (id_1, includeGlobalAccounts_1) {
        return __awaiter(this, arguments, void 0, function (id, includeGlobalAccounts, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/account-links/project/{id}'
                    .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                ...
                // verify required parameter 'id' is not null or undefined
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling getLinksByProject.');
                }
                if (includeGlobalAccounts !== undefined) {
                    localVarQueryParameters['includeGlobalAccounts'] = models_1.ObjectSerializer.serialize(includeGlobalAccounts, "boolean");
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "AccountLinkResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param id An integer uniquely identifying the &#x60;AccountLink&#x60;
     */
    AccountLinksApi.prototype.patchLink = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_5, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/account-links/{id}/make-default'
                    .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                localVarFormParams = {};
                // verify required parameter 'id' is not null or undefined
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling patchLink.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
    ...
    return AccountLinksApi;
}());
exports.AccountLinksApi = AccountLinksApi;
