...
})(AccountsApiApiKeys || (exports.AccountsApiApiKeys = AccountsApiApiKeys = {}));
var AccountsApi = /** @class */ (function () {
    ...
    Object.defineProperty(AccountsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    AccountsApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param accountInput
     */
    AccountsApi.prototype.createAccount = function (accountInput_1) {
        return __awaiter(this, arguments, void 0, function (accountInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(accountInput, "AccountInput")
                };
     ...
     */
    AccountsApi.prototype.deleteAccount = function (key_1) {
        return __awaiter(this, arguments, void 0, function (key, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/accounts/{key}'
     ...
     */
    AccountsApi.prototype.getAccountById = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/accounts/{id}'
     ...
     */
    AccountsApi.prototype.getAccountLinks = function (key_1, offset_1, limit_1) {
        return __awaiter(this, arguments, void 0, function (key, offset, limit, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/accounts/{key}/links'
                    .replace('{' + 'key' + '}', encodeURIComponent(String(key)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableAccountLink");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param limit Limit the number of elements on the response
     */
    AccountsApi.prototype.getAccounts = function (offset_1, limit_1) {
     ...
     */
    AccountsApi.prototype.searchAccounts = function (offset_1, limit_1, accountSearchInput_1) {
        return __awaiter(this, arguments, void 0, function (offset, limit, accountSearchInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/accounts/search';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(accountSearchInput, "AccountSearchInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
     ...
     * @param accountInput
     */
    AccountsApi.prototype.updateAccount = function (key_1, accountInput_1) {
        return __awaiter(this, arguments, void 0, function (key, accountInput, options) {
