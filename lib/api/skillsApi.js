...
exports.SkillsApi = exports.SkillsApiApiKeys = void 0;
...
})(SkillsApiApiKeys || (exports.SkillsApiApiKeys = SkillsApiApiKeys = {}));
var SkillsApi = /** @class */ (function () {
    function SkillsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(SkillsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(SkillsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(SkillsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    SkillsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    SkillsApi.prototype.setApiKey = function (key, value) {
        this.authentications[SkillsApiApiKeys[key]].apiKey = value;
    };
    SkillsApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param skillInput
     */
    SkillsApi.prototype.createSkill = function (skillInput_1) {
        return __awaiter(this, arguments, void 0, function (skillInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(skillInput, "SkillInput")
                };
     ...
     * @param id An id that uniquely identifies the Skill
     */
    SkillsApi.prototype.deleteSkill = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/skills/{id}'
                ...
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling deleteSkill.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param id An id that uniquely identifies the Skill
     */
    SkillsApi.prototype.getSkill = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
     ...
     * @param id Ids of the Skills you want to retrieve
     * @param query A query to be used for string matching against name of Skills
     * @param offset Skip over a number of elements by specifying an offset value for the query
     * @param limit Limit the number of elements on the response
     */
    SkillsApi.prototype.getSkills = function (id_1, query_1, offset_1, limit_1) {
        return __awaiter(this, arguments, void 0, function (id, query, offset, limit, options) {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (id !== undefined) {
                    localVarQueryParameters['id'] = models_1.ObjectSerializer.serialize(id, "Array<number>");
                }
                if (query !== undefined) {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableSkill");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param skillInput
     */
    SkillsApi.prototype.updateSkill = function (id_1, skillInput_1) {
        return __awaiter(this, arguments, void 0, function (id, skillInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'id' is not null or undefined
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling updateSkill.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
