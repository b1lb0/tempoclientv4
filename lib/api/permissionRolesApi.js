...
exports.PermissionRolesApi = exports.PermissionRolesApiApiKeys = void 0;
...
// ===============================================
var PermissionRolesApiApiKeys;
(function (PermissionRolesApiApiKeys) {
})(PermissionRolesApiApiKeys || (exports.PermissionRolesApiApiKeys = PermissionRolesApiApiKeys = {}));
var PermissionRolesApi = /** @class */ (function () {
    function PermissionRolesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PermissionRolesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PermissionRolesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(PermissionRolesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    PermissionRolesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PermissionRolesApi.prototype.setApiKey = function (key, value) {
        this.authentications[PermissionRolesApiApiKeys[key]].apiKey = value;
    };
    PermissionRolesApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param permissionRoleInput
     */
    PermissionRolesApi.prototype.createPermissionGroup = function (permissionRoleInput_1) {
        return __awaiter(this, arguments, void 0, function (permissionRoleInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/permission-roles';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(permissionRoleInput, "PermissionRoleInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PermissionRole");
     ...
     * @param id
     */
    PermissionRolesApi.prototype.deleteEditablePermissionGroup = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/permission-roles/{id}'
                ...
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling deleteEditablePermissionGroup.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     */
    PermissionRolesApi.prototype.getGlobalPermissionRoles = function (offset_1, limit_1) {
        return __awaiter(this, arguments, void 0, function (offset, limit, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/permission-roles/global';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageablePermissionRole");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param id ID of the permission role
     */
    PermissionRolesApi.prototype.getPermissionRole = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'id' is not null or undefined
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling getPermissionRole.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param offset Skip over a number of elements by specifying an offset value for the query
     * @param limit Limit the number of elements on the response
     * @param teamId An ID that uniquely identifies the Team for which you want to retrieve Permissions
     */
    PermissionRolesApi.prototype.getPermissionRoles = function (offset_1, limit_1, teamId_1) {
        return __awaiter(this, arguments, void 0, function (offset, limit, teamId, options) {
            ...
            return __generator(this, function (_b) {
                ...
                if (teamId !== undefined) {
                    localVarQueryParameters['teamId'] = models_1.ObjectSerializer.serialize(teamId, "string");
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param permissionRoleInput
     */
    PermissionRolesApi.prototype.updatePermissionGroup = function (id_1, permissionRoleInput_1) {
        return __awaiter(this, arguments, void 0, function (id, permissionRoleInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'id' is not null or undefined
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling updatePermissionGroup.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
    ...
    return PermissionRolesApi;
}());
exports.PermissionRolesApi = PermissionRolesApi;
