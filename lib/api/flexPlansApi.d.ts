...
export declare enum FlexPlansApiApiKeys {
}
export declare class FlexPlansApi {
    ...
    setApiKey(key: FlexPlansApiApiKeys, value: string): void;
     ...
     * @param flexPlanInput
     */
    createFlexPlan(flexPlanInput?: FlexPlanInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    deleteFlexPlanById(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id An id that uniquely identifies the Flex Plan
     */
    getFlexPlanById(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    searchFlexPlans(flexPlanSearchInput?: FlexPlanSearchInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: FlexPlanSearchResult;
    }>;
    /**
     ...
     * @param flexPlanInput
     */
    updateFlexPlan(id: number, flexPlanInput?: FlexPlanInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=flexPlansApi.d.ts.map