...
exports.GenericResourceTeamMembersApi = exports.GenericResourceTeamMembersApiApiKeys = void 0;
...
// ===============================================
var GenericResourceTeamMembersApiApiKeys;
(function (GenericResourceTeamMembersApiApiKeys) {
})(GenericResourceTeamMembersApiApiKeys || (exports.GenericResourceTeamMembersApiApiKeys = GenericResourceTeamMembersApiApiKeys = {}));
var GenericResourceTeamMembersApi = /** @class */ (function () {
    function GenericResourceTeamMembersApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(GenericResourceTeamMembersApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(GenericResourceTeamMembersApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(GenericResourceTeamMembersApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    GenericResourceTeamMembersApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    GenericResourceTeamMembersApi.prototype.setApiKey = function (key, value) {
        this.authentications[GenericResourceTeamMembersApiApiKeys[key]].apiKey = value;
    };
    GenericResourceTeamMembersApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    /**
     * Adds Generic Resource to the given Team
     * @summary Add Generic Resource to Team
     * @param teamId An id that uniquely identifies the Team which the generic resource is to be a member of
     * @param genericResourceTeamMemberInput
     */
    GenericResourceTeamMembersApi.prototype.addResourceToTeam = function (teamId_1, genericResourceTeamMemberInput_1) {
        return __awaiter(this, arguments, void 0, function (teamId, genericResourceTeamMemberInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/teams/{teamId}/generic-resources'
                ...
                if (teamId === null || teamId === undefined) {
                    throw new Error('Required parameter teamId was null or undefined when calling addResourceToTeam.');
                }
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(genericResourceTeamMemberInput, "GenericResourceTeamMemberInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "GenericResourceTeamMember");
     ...
     * @param teamId An id that uniquely identifies the Team
     * @param resourceId An id that uniquely identifies the Generic Resource
     */
    GenericResourceTeamMembersApi.prototype.getGenericResourceTeamMember = function (teamId_1, resourceId_1) {
        return __awaiter(this, arguments, void 0, function (teamId, resourceId, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/teams/{teamId}/generic-resources/{resourceId}'
                    .replace('{' + 'teamId' + '}', encodeURIComponent(String(teamId)))
                ...
                // verify required parameter 'teamId' is not null or undefined
                if (teamId === null || teamId === undefined) {
                    throw new Error('Required parameter teamId was null or undefined when calling getGenericResourceTeamMember.');
                }
                // verify required parameter 'resourceId' is not null or undefined
                if (resourceId === null || resourceId === undefined) {
                    throw new Error('Required parameter resourceId was null or undefined when calling getGenericResourceTeamMember.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param teamId An id that uniquely identifies the Team from which generic resources are to be retrieved
     */
    GenericResourceTeamMembersApi.prototype.getResourcesInTeam = function (teamId_1) {
        return __awaiter(this, arguments, void 0, function (teamId, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'teamId' is not null or undefined
                if (teamId === null || teamId === undefined) {
                    throw new Error('Required parameter teamId was null or undefined when calling getResourcesInTeam.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "GenericResourceTeamMembers");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param resourceId An id that uniquely identifies the Generic Resource
     */
    GenericResourceTeamMembersApi.prototype.removeGenericResourceFromTeam = function (teamId_1, resourceId_1) {
        return __awaiter(this, arguments, void 0, function (teamId, resourceId, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'teamId' is not null or undefined
                if (teamId === null || teamId === undefined) {
                    throw new Error('Required parameter teamId was null or undefined when calling removeGenericResourceFromTeam.');
                }
                // verify required parameter 'resourceId' is not null or undefined
                if (resourceId === null || resourceId === undefined) {
                    throw new Error('Required parameter resourceId was null or undefined when calling removeGenericResourceFromTeam.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
    ...
    return GenericResourceTeamMembersApi;
}());
exports.GenericResourceTeamMembersApi = GenericResourceTeamMembersApi;
