...
export declare enum PlanApprovalsApiApiKeys {
}
export declare class PlanApprovalsApi {
    ...
    setApiKey(key: PlanApprovalsApiApiKeys, value: string): void;
     ...
     */
    getPlansForReview(planApprovalSearchBean?: PlanApprovalSearchBean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PlanApprovalsResult;
    }>;
    /**
     ...
     */
    getPossiblePlanReviewers(accountId: string, from?: string, to?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    updatePlanApproval(allocationId: number, planApprovalInput?: PlanApprovalInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=planApprovalsApi.d.ts.map