...
export declare enum HolidaySchemesApiApiKeys {
}
export declare class HolidaySchemesApi {
    ...
    setApiKey(key: HolidaySchemesApiApiKeys, value: string): void;
     ...
     * @param holidayInput
     */
    createHoliday(schemeId: string, holidayInput?: HolidayInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    createHolidayScheme(holidaySchemeInputBean?: HolidaySchemeInputBean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    deleteHoliday(schemeId: string, holidayId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param schemeId The id of the Scheme
     */
    deleteHolidayScheme(schemeId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param schemeId The id of the Scheme
     */
    getFloatingHolidays(schemeId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param holidayId The id of the holiday
     */
    getHoliday(schemeId: string, holidayId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param schemeId The id of the Scheme
     */
    getHolidayScheme(schemeId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getHolidaySchemes(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: HolidaySchemeResults;
    }>;
    /**
     ...
     */
    getHolidays(schemeId: string, year?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getUserHolidayScheme(accountId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getWorkloadSchemeMembers(schemeId: string, offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param schemeId The id of the Scheme
     */
    setDefaultScheme(schemeId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    setWorkloadSchemeMembership(schemeId: string, holidaySchemeMembersInput?: HolidaySchemeMembersInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param holidayInput
     */
    updateHoliday(schemeId: string, holidayId: string, holidayInput?: HolidayInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param holidaySchemeInputBean
     */
    updateHolidayScheme(schemeId: string, holidaySchemeInputBean?: HolidaySchemeInputBean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=holidaySchemesApi.d.ts.map