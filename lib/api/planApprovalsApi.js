...
exports.PlanApprovalsApi = exports.PlanApprovalsApiApiKeys = void 0;
...
// ===============================================
var PlanApprovalsApiApiKeys;
(function (PlanApprovalsApiApiKeys) {
})(PlanApprovalsApiApiKeys || (exports.PlanApprovalsApiApiKeys = PlanApprovalsApiApiKeys = {}));
var PlanApprovalsApi = /** @class */ (function () {
    function PlanApprovalsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PlanApprovalsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PlanApprovalsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(PlanApprovalsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    PlanApprovalsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PlanApprovalsApi.prototype.setApiKey = function (key, value) {
        this.authentications[PlanApprovalsApiApiKeys[key]].apiKey = value;
    };
    PlanApprovalsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    /**
     * Get plans for review based on the search criteria.
     * @summary Get plans for review
     * @param planApprovalSearchBean
     */
    PlanApprovalsApi.prototype.getPlansForReview = function (planApprovalSearchBean_1) {
        return __awaiter(this, arguments, void 0, function (planApprovalSearchBean, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plan-approvals/plans-for-review';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(planApprovalSearchBean, "PlanApprovalSearchBean")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PlanApprovalsResult");
     ...
     * @param accountId The account ID of the user to find reviewers for
     * @param from Start date in yyyy-MM-dd format
     * @param to End date in yyyy-MM-dd format
     */
    PlanApprovalsApi.prototype.getPossiblePlanReviewers = function (accountId_1, from_1, to_1) {
        return __awaiter(this, arguments, void 0, function (accountId, from, to, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plan-permissions/plan-reviewers';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                if (accountId === null || accountId === undefined) {
                    throw new Error('Required parameter accountId was null or undefined when calling getPossiblePlanReviewers.');
                }
                if (accountId !== undefined) {
                    localVarQueryParameters['accountId'] = models_1.ObjectSerializer.serialize(accountId, "string");
                }
                if (from !== undefined) {
     ...
     */
    PlanApprovalsApi.prototype.updatePlanApproval = function (allocationId_1, planApprovalInput_1) {
        return __awaiter(this, arguments, void 0, function (allocationId, planApprovalInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plan-approvals/{allocationId}'
                ...
                if (allocationId === null || allocationId === undefined) {
                    throw new Error('Required parameter allocationId was null or undefined when calling updatePlanApproval.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(planApprovalInput, "PlanApprovalInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PlanApproval");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
    ...
    return PlanApprovalsApi;
}());
exports.PlanApprovalsApi = PlanApprovalsApi;
