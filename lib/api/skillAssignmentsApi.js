...
exports.SkillAssignmentsApi = exports.SkillAssignmentsApiApiKeys = void 0;
...
// ===============================================
var SkillAssignmentsApiApiKeys;
(function (SkillAssignmentsApiApiKeys) {
})(SkillAssignmentsApiApiKeys || (exports.SkillAssignmentsApiApiKeys = SkillAssignmentsApiApiKeys = {}));
var SkillAssignmentsApi = /** @class */ (function () {
    function SkillAssignmentsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(SkillAssignmentsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(SkillAssignmentsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(SkillAssignmentsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    SkillAssignmentsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    SkillAssignmentsApi.prototype.setApiKey = function (key, value) {
        this.authentications[SkillAssignmentsApiApiKeys[key]].apiKey = value;
    };
    SkillAssignmentsApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param skillsAssignmentInput
     */
    SkillAssignmentsApi.prototype.assignSkills = function (skillsAssignmentInput_1) {
        return __awaiter(this, arguments, void 0, function (skillsAssignmentInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/skill-assignments';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(skillsAssignmentInput, "SkillsAssignmentInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "Array<Skill>");
     ...
     * @param assigneeId A string that uniquely identifies the resource
     * @param assigneeType A string that identifies the resource type, which can be USER or GENERIC
     */
    SkillAssignmentsApi.prototype.getSkillAssignments = function (assigneeId_1, assigneeType_1) {
        return __awaiter(this, arguments, void 0, function (assigneeId, assigneeType, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/skill-assignments/{assigneeId}/{assigneeType}'
                    .replace('{' + 'assigneeId' + '}', encodeURIComponent(String(assigneeId)))
                    .replace('{' + 'assigneeType' + '}', encodeURIComponent(String(assigneeType)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                if (assigneeId === null || assigneeId === undefined) {
                    throw new Error('Required parameter assigneeId was null or undefined when calling getSkillAssignments.');
                }
                // verify required parameter 'assigneeType' is not null or undefined
                if (assigneeType === null || assigneeType === undefined) {
                    throw new Error('Required parameter assigneeType was null or undefined when calling getSkillAssignments.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param assigneeId A string that uniquely identifies the resource
     * @param assigneeType A string that identifies the resource type, which can be USER or GENERIC
     * @param skillId An id that uniquely identify the Skill
     */
    SkillAssignmentsApi.prototype.removeSkillAssignment = function (assigneeId_1, assigneeType_1, skillId_1) {
        return __awaiter(this, arguments, void 0, function (assigneeId, assigneeType, skillId, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/skill-assignments/{assigneeId}/{assigneeType}/{skillId}'
                    .replace('{' + 'assigneeId' + '}', encodeURIComponent(String(assigneeId)))
                    .replace('{' + 'assigneeType' + '}', encodeURIComponent(String(assigneeType)))
                ...
                // verify required parameter 'assigneeId' is not null or undefined
                if (assigneeId === null || assigneeId === undefined) {
                    throw new Error('Required parameter assigneeId was null or undefined when calling removeSkillAssignment.');
                }
                // verify required parameter 'assigneeType' is not null or undefined
                if (assigneeType === null || assigneeType === undefined) {
                    throw new Error('Required parameter assigneeType was null or undefined when calling removeSkillAssignment.');
                }
                // verify required parameter 'skillId' is not null or undefined
                if (skillId === null || skillId === undefined) {
                    throw new Error('Required parameter skillId was null or undefined when calling removeSkillAssignment.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param skillsAssignmentInput
     */
    SkillAssignmentsApi.prototype.replaceSkillAssignments = function (skillsAssignmentInput_1) {
        return __awaiter(this, arguments, void 0, function (skillsAssignmentInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/skill-assignments/replace';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
    ...
    return SkillAssignmentsApi;
}());
exports.SkillAssignmentsApi = SkillAssignmentsApi;
