...
exports.PlansApi = exports.PlansApiApiKeys = void 0;
...
})(PlansApiApiKeys || (exports.PlansApiApiKeys = PlansApiApiKeys = {}));
var PlansApi = /** @class */ (function () {
    function PlansApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PlansApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PlansApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(PlansApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    PlansApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PlansApi.prototype.setApiKey = function (key, value) {
        this.authentications[PlansApiApiKeys[key]].apiKey = value;
    };
    PlansApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param planInput
     */
    PlansApi.prototype.createPlan = function (planInput_1) {
        return __awaiter(this, arguments, void 0, function (planInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plans';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(planInput, "PlanInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "Plan");
     ...
     */
    PlansApi.prototype.deleteDayFromPlan = function (id_1, day_1) {
        return __awaiter(this, arguments, void 0, function (id, day, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plans/{id}/partial/{day}'
     ...
     * @param id An id that uniquely identifies the Plan
     */
    PlansApi.prototype.deletePlanById = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plans/{id}'
                    .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                localVarFormParams = {};
     ...
     * @param to
     */
    PlansApi.prototype.getPlanById = function (id_1, from_1, to_1) {
        return __awaiter(this, arguments, void 0, function (id, from, to, options) {
     ...
     */
    PlansApi.prototype.getPlans = function (from_1, to_1, accountIds_1, assigneeTypes_1, genericResourceIds_1, limit_1, offset_1, planIds_1, planItemIds_1, planItemTypes_1, plannedTimeBreakdown_1, updatedFrom_1) {
        return __awaiter(this, arguments, void 0, function (from, to, accountIds, assigneeTypes, genericResourceIds, limit, offset, planIds, planItemIds, planItemTypes, plannedTimeBreakdown, updatedFrom, options) {
            ...
            return __generator(this, function (_b) {
                ...
                if (accountIds !== undefined) {
                    localVarQueryParameters['accountIds'] = models_1.ObjectSerializer.serialize(accountIds, "Array<string>");
                }
                if (assigneeTypes !== undefined) {
                    localVarQueryParameters['assigneeTypes'] = models_1.ObjectSerializer.serialize(assigneeTypes, "Array<'USER' | 'GENERIC'>");
                }
                if (from !== undefined) {
                    localVarQueryParameters['from'] = models_1.ObjectSerializer.serialize(from, "string");
                }
                if (genericResourceIds !== undefined) {
                    localVarQueryParameters['genericResourceIds'] = models_1.ObjectSerializer.serialize(genericResourceIds, "Array<number>");
                }
                if (limit !== undefined) {
                ...
                if (planIds !== undefined) {
                    localVarQueryParameters['planIds'] = models_1.ObjectSerializer.serialize(planIds, "Array<number>");
                }
                if (planItemIds !== undefined) {
                    localVarQueryParameters['planItemIds'] = models_1.ObjectSerializer.serialize(planItemIds, "Array<number>");
                }
                if (planItemTypes !== undefined) {
                    localVarQueryParameters['planItemTypes'] = models_1.ObjectSerializer.serialize(planItemTypes, "Array<'ISSUE' | 'PROJECT'>");
                }
                if (plannedTimeBreakdown !== undefined) {
                    localVarQueryParameters['plannedTimeBreakdown'] = models_1.ObjectSerializer.serialize(plannedTimeBreakdown, "Array<'DAILY' | 'PERIOD'>");
                }
                if (to !== undefined) {
                    localVarQueryParameters['to'] = models_1.ObjectSerializer.serialize(to, "string");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageablePlan");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param updatedFrom Retrieve plans that have been updated from this date
     */
    PlansApi.prototype.getPlansForGenericResource = function (genericResourceId_1, plannedTimeBreakdown_1, from_1, to_1, updatedFrom_1) {
        return __awaiter(this, arguments, void 0, function (genericResourceId, plannedTimeBreakdown, from, to, updatedFrom, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plans/generic-resource/{genericResourceId}'
                ...
                if (plannedTimeBreakdown !== undefined) {
                    localVarQueryParameters['plannedTimeBreakdown'] = models_1.ObjectSerializer.serialize(plannedTimeBreakdown, "Array<string>");
                }
                if (from !== undefined) {
                    localVarQueryParameters['from'] = models_1.ObjectSerializer.serialize(from, "string");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PlanResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param updatedFrom Retrieve plans that have been updated from this date
     */
    PlansApi.prototype.getPlansForUser = function (accountId_1, plannedTimeBreakdown_1, from_1, to_1, updatedFrom_1) {
        return __awaiter(this, arguments, void 0, function (accountId, plannedTimeBreakdown, from, to, updatedFrom, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plans/user/{accountId}'
     ...
     */
    PlansApi.prototype.searchPlans = function (planSearchInput_1) {
        return __awaiter(this, arguments, void 0, function (planSearchInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/plans/search';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(planSearchInput, "PlanSearchInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageablePlanBeanWithoutLinks");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param planInput
     */
    PlansApi.prototype.updatePartialPlan = function (id_1, day_1, planInput_1) {
        return __awaiter(this, arguments, void 0, function (id, day, planInput, options) {
     ...
     * @param planInput
     */
    PlansApi.prototype.updatePlan = function (id_1, planInput_1) {
        return __awaiter(this, arguments, void 0, function (id, planInput, options) {
