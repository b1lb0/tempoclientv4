...
export declare enum TeamLinksApiApiKeys {
}
export declare class TeamLinksApi {
    ...
    setApiKey(key: TeamLinksApiApiKeys, value: string): void;
     ...
     * @param teamLinkInput
     */
    createTeamLink(teamLinkInput?: TeamLinkInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param linkId
     */
    deleteTeamLink(linkId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param linkId
     */
    getTeamLink(linkId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id
     */
    getTeamLinkByProjectId(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: TeamLinkResults;
    }>;
}
//# sourceMappingURL=teamLinksApi.d.ts.map