...
export declare class TeamApi {
     ...
     * @param teamInput
     */
    createTeam(teamInput?: TeamInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getTeamLinks(id: string, offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageableTeamLink;
    }>;
    /**
     ...
     * @param id
     */
    getTeamMembers(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageableMemberMemberships;
    }>;
    /**
     ...
     */
    getTeams(offset?: number, limit?: number, teamMembers?: Array<string>, name?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param teamInput
     */
    updateTeam(id: string, teamInput?: TeamInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
