...
export declare enum AccountLinksApiApiKeys {
}
export declare class AccountLinksApi {
    ...
    setApiKey(key: AccountLinksApiApiKeys, value: string): void;
     ...
     */
    createLink(accountLinkInput?: AccountLinkInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getLinksByProject(id: number, includeGlobalAccounts?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: AccountLinkResults;
    }>;
    /**
...
//# sourceMappingURL=accountLinksApi.d.ts.map