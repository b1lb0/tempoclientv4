...
exports.FlexPlansApi = exports.FlexPlansApiApiKeys = void 0;
...
// ===============================================
var FlexPlansApiApiKeys;
(function (FlexPlansApiApiKeys) {
})(FlexPlansApiApiKeys || (exports.FlexPlansApiApiKeys = FlexPlansApiApiKeys = {}));
var FlexPlansApi = /** @class */ (function () {
    function FlexPlansApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(FlexPlansApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(FlexPlansApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(FlexPlansApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    FlexPlansApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    FlexPlansApi.prototype.setApiKey = function (key, value) {
        this.authentications[FlexPlansApiApiKeys[key]].apiKey = value;
    };
    FlexPlansApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param flexPlanInput
     */
    FlexPlansApi.prototype.createFlexPlan = function (flexPlanInput_1) {
        return __awaiter(this, arguments, void 0, function (flexPlanInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/flex-plans';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(flexPlanInput, "FlexPlanInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "FlexPlan");
     ...
     */
    FlexPlansApi.prototype.deleteFlexPlanById = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/flex-plans/{id}'
     ...
     * @param id An id that uniquely identifies the Flex Plan
     */
    FlexPlansApi.prototype.getFlexPlanById = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
     ...
     */
    FlexPlansApi.prototype.searchFlexPlans = function (flexPlanSearchInput_1) {
        return __awaiter(this, arguments, void 0, function (flexPlanSearchInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/flex-plans/search';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(flexPlanSearchInput, "FlexPlanSearchInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "FlexPlanSearchResult");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param flexPlanInput
     */
    FlexPlansApi.prototype.updateFlexPlan = function (id_1, flexPlanInput_1) {
        return __awaiter(this, arguments, void 0, function (id, flexPlanInput, options) {
...
exports.FlexPlansApi = FlexPlansApi;
