...
export declare enum GenericResourceTeamMembersApiApiKeys {
}
export declare class GenericResourceTeamMembersApi {
    ...
    setApiKey(key: GenericResourceTeamMembersApiApiKeys, value: string): void;
     ...
     */
    addResourceToTeam(teamId: number, genericResourceTeamMemberInput?: GenericResourceTeamMemberInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: GenericResourceTeamMember;
    }>;
    /**
     ...
     */
    getGenericResourceTeamMember(teamId: number, resourceId: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getResourcesInTeam(teamId: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: GenericResourceTeamMembers;
    }>;
    /**
     ...
     * @param resourceId An id that uniquely identifies the Generic Resource
     */
    removeGenericResourceFromTeam(teamId: number, resourceId: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=genericResourceTeamMembersApi.d.ts.map