...
exports.WorkAttributesApi = exports.WorkAttributesApiApiKeys = void 0;
...
// ===============================================
var WorkAttributesApiApiKeys;
(function (WorkAttributesApiApiKeys) {
})(WorkAttributesApiApiKeys || (exports.WorkAttributesApiApiKeys = WorkAttributesApiApiKeys = {}));
var WorkAttributesApi = /** @class */ (function () {
    function WorkAttributesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(WorkAttributesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(WorkAttributesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(WorkAttributesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    WorkAttributesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    WorkAttributesApi.prototype.setApiKey = function (key, value) {
        this.authentications[WorkAttributesApiApiKeys[key]].apiKey = value;
    };
    WorkAttributesApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    WorkAttributesApi.prototype.createWorkAttributes = function (createWorkAttributeInput_1) {
        return __awaiter(this, arguments, void 0, function (createWorkAttributeInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/work-attributes';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(createWorkAttributeInput, "CreateWorkAttributeInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "WorkAttribute");
     ...
     * @param key
     */
    WorkAttributesApi.prototype.deleteWorkAttributeByKey = function (key_1) {
        return __awaiter(this, arguments, void 0, function (key, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/work-attributes/{key}'
     ...
     * @param key
     */
    WorkAttributesApi.prototype.getWorkAttributeByKey = function (key_1) {
        return __awaiter(this, arguments, void 0, function (key, options) {
     ...
     */
    WorkAttributesApi.prototype.getWorkAttributes = function (offset_1, limit_1) {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableWorkAttribute");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     */
    WorkAttributesApi.prototype.updateWorkAttributeByKey = function (key_1, updateWorkAttributeInput_1) {
        return __awaiter(this, arguments, void 0, function (key, updateWorkAttributeInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(updateWorkAttributeInput, "UpdateWorkAttributeInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
    ...
    return WorkAttributesApi;
}());
exports.WorkAttributesApi = WorkAttributesApi;
