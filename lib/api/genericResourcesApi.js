...
exports.GenericResourcesApi = exports.GenericResourcesApiApiKeys = void 0;
...
// ===============================================
var GenericResourcesApiApiKeys;
(function (GenericResourcesApiApiKeys) {
})(GenericResourcesApiApiKeys || (exports.GenericResourcesApiApiKeys = GenericResourcesApiApiKeys = {}));
var GenericResourcesApi = /** @class */ (function () {
    function GenericResourcesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(GenericResourcesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(GenericResourcesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(GenericResourcesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    GenericResourcesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    GenericResourcesApi.prototype.setApiKey = function (key, value) {
        this.authentications[GenericResourcesApiApiKeys[key]].apiKey = value;
    };
    GenericResourcesApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param genericResourceInput
     */
    GenericResourcesApi.prototype.createGenericResource = function (genericResourceInput_1) {
        return __awaiter(this, arguments, void 0, function (genericResourceInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/generic-resources';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(genericResourceInput, "GenericResourceInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "GenericResource");
     ...
     * @param id An id that uniquely identifies the Generic Resource
     */
    GenericResourcesApi.prototype.deleteGenericResource = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/generic-resources/{id}'
                ...
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling deleteGenericResource.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param genericResourceInput
     */
    GenericResourcesApi.prototype.editGenericResource = function (id_1, genericResourceInput_1) {
        return __awaiter(this, arguments, void 0, function (id, genericResourceInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'id' is not null or undefined
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling editGenericResource.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param id An id that uniquely identifies the Generic Resource
     */
    GenericResourcesApi.prototype.getGenericResource = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'id' is not null or undefined
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling getGenericResource.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param genericResourceSearchInput
     */
    GenericResourcesApi.prototype.searchGenericResources = function (genericResourceSearchInput_1) {
        return __awaiter(this, arguments, void 0, function (genericResourceSearchInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/generic-resources/search';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(genericResourceSearchInput, "GenericResourceSearchInput")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "PageableGenericResourceWithoutSelfLink");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
    ...
    return GenericResourcesApi;
}());
exports.GenericResourcesApi = GenericResourcesApi;
