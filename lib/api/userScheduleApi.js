...
exports.UserScheduleApi = exports.UserScheduleApiApiKeys = void 0;
...
// ===============================================
var UserScheduleApiApiKeys;
(function (UserScheduleApiApiKeys) {
})(UserScheduleApiApiKeys || (exports.UserScheduleApiApiKeys = UserScheduleApiApiKeys = {}));
var UserScheduleApi = /** @class */ (function () {
    function UserScheduleApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(UserScheduleApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(UserScheduleApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(UserScheduleApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    UserScheduleApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    UserScheduleApi.prototype.setApiKey = function (key, value) {
        this.authentications[UserScheduleApiApiKeys[key]].apiKey = value;
    };
    UserScheduleApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    UserScheduleApi.prototype.getAuthenticatedUserSchedule = function (from_1, to_1) {
        return __awaiter(this, arguments, void 0, function (from, to, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/user-schedule';
                ...
                if (from === null || from === undefined) {
                    throw new Error('Required parameter from was null or undefined when calling getAuthenticatedUserSchedule.');
                }
                // verify required parameter 'to' is not null or undefined
                if (to === null || to === undefined) {
                    throw new Error('Required parameter to was null or undefined when calling getAuthenticatedUserSchedule.');
                }
                if (from !== undefined) {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "DayScheduleResults");
     ...
     * @param to The end date in format yyyy-mm-dd
     */
    UserScheduleApi.prototype.getUserSchedule = function (accountId_1, from_1, to_1) {
        return __awaiter(this, arguments, void 0, function (accountId, from, to, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/user-schedule/{accountId}'
                ...
                if (accountId === null || accountId === undefined) {
                    throw new Error('Required parameter accountId was null or undefined when calling getUserSchedule.');
                }
                // verify required parameter 'from' is not null or undefined
                if (from === null || from === undefined) {
                    throw new Error('Required parameter from was null or undefined when calling getUserSchedule.');
                }
                // verify required parameter 'to' is not null or undefined
                if (to === null || to === undefined) {
                    throw new Error('Required parameter to was null or undefined when calling getUserSchedule.');
                }
                if (from !== undefined) {
                    localVarQueryParameters['from'] = models_1.ObjectSerializer.serialize(from, "string");
                }
    ...
    return UserScheduleApi;
}());
exports.UserScheduleApi = UserScheduleApi;
