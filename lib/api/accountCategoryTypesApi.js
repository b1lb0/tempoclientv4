...
exports.AccountCategoryTypesApi = exports.AccountCategoryTypesApiApiKeys = void 0;
...
// ===============================================
var AccountCategoryTypesApiApiKeys;
(function (AccountCategoryTypesApiApiKeys) {
})(AccountCategoryTypesApiApiKeys || (exports.AccountCategoryTypesApiApiKeys = AccountCategoryTypesApiApiKeys = {}));
var AccountCategoryTypesApi = /** @class */ (function () {
    function AccountCategoryTypesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AccountCategoryTypesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AccountCategoryTypesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(AccountCategoryTypesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    AccountCategoryTypesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AccountCategoryTypesApi.prototype.setApiKey = function (key, value) {
        this.authentications[AccountCategoryTypesApiApiKeys[key]].apiKey = value;
    };
    AccountCategoryTypesApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    AccountCategoryTypesApi.prototype.getTypes = function () {
        return __awaiter(this, arguments, void 0, function (options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/account-category-types';
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "CategoryTypeResults");
    ...
    return AccountCategoryTypesApi;
}());
exports.AccountCategoryTypesApi = AccountCategoryTypesApi;
