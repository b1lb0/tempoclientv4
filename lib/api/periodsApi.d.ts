...
export declare enum PeriodsApiApiKeys {
}
export declare class PeriodsApi {
    ...
    setApiKey(key: PeriodsApiApiKeys, value: string): void;
     ...
     */
    getPeriods(from: string, to: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: TimesheetApprovalPeriodsBean;
    }>;
}
//# sourceMappingURL=periodsApi.d.ts.map