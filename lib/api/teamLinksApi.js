...
exports.TeamLinksApi = exports.TeamLinksApiApiKeys = void 0;
...
// ===============================================
var TeamLinksApiApiKeys;
(function (TeamLinksApiApiKeys) {
})(TeamLinksApiApiKeys || (exports.TeamLinksApiApiKeys = TeamLinksApiApiKeys = {}));
var TeamLinksApi = /** @class */ (function () {
    function TeamLinksApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(TeamLinksApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(TeamLinksApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(TeamLinksApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    TeamLinksApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    TeamLinksApi.prototype.setApiKey = function (key, value) {
        this.authentications[TeamLinksApiApiKeys[key]].apiKey = value;
    };
    TeamLinksApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param teamLinkInput
     */
    TeamLinksApi.prototype.createTeamLink = function (teamLinkInput_1) {
        return __awaiter(this, arguments, void 0, function (teamLinkInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/team-links';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(teamLinkInput, "TeamLinkInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TeamLink");
     ...
     * @param linkId
     */
    TeamLinksApi.prototype.deleteTeamLink = function (linkId_1) {
        return __awaiter(this, arguments, void 0, function (linkId, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/team-links/{linkId}'
                ...
                if (linkId === null || linkId === undefined) {
                    throw new Error('Required parameter linkId was null or undefined when calling deleteTeamLink.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param linkId
     */
    TeamLinksApi.prototype.getTeamLink = function (linkId_1) {
        return __awaiter(this, arguments, void 0, function (linkId, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'linkId' is not null or undefined
                if (linkId === null || linkId === undefined) {
                    throw new Error('Required parameter linkId was null or undefined when calling getTeamLink.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param id
     */
    TeamLinksApi.prototype.getTeamLinkByProjectId = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/team-links/project/{id}'
                ...
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling getTeamLinkByProjectId.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TeamLinkResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
...
exports.TeamLinksApi = TeamLinksApi;
