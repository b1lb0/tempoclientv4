...
})(RolesApiApiKeys || (exports.RolesApiApiKeys = RolesApiApiKeys = {}));
var RolesApi = /** @class */ (function () {
    function RolesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(RolesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(RolesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(RolesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    RolesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    RolesApi.prototype.setApiKey = function (key, value) {
        this.authentications[RolesApiApiKeys[key]].apiKey = value;
    };
    RolesApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param roleInput
     */
    RolesApi.prototype.createRole = function (roleInput_1) {
        return __awaiter(this, arguments, void 0, function (roleInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(roleInput, "RoleInput")
                };
     ...
     */
    RolesApi.prototype.deleteRole = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/roles/{id}'
     ...
     */
    RolesApi.prototype.getAllRoles = function () {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "RoleResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     */
    RolesApi.prototype.getDefaultRole = function () {
        return __awaiter(this, arguments, void 0, function (options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/roles/default';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
     ...
     * @param id An id that uniquely identifies the Role
     */
    RolesApi.prototype.getRoleById = function (id_1) {
        return __awaiter(this, arguments, void 0, function (id, options) {
     ...
     * @param roleInput
     */
    RolesApi.prototype.updateRole = function (id_1, roleInput_1) {
        return __awaiter(this, arguments, void 0, function (id, roleInput, options) {
