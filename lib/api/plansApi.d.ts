...
export declare class PlansApi {
     ...
     * @param planInput
     */
    createPlan(planInput?: PlanInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    deleteDayFromPlan(id: number, day: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id An id that uniquely identifies the Plan
     */
    deletePlanById(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param to
     */
    getPlanById(id: number, from?: string, to?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getPlans(from: string, to: string, accountIds?: Array<string>, assigneeTypes?: Array<'USER' | 'GENERIC'>, genericResourceIds?: Array<number>, limit?: number, offset?: number, planIds?: Array<number>, planItemIds?: Array<number>, planItemTypes?: Array<'ISSUE' | 'PROJECT'>, plannedTimeBreakdown?: Array<'DAILY' | 'PERIOD'>, updatedFrom?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param updatedFrom Retrieve plans that have been updated from this date
     */
    getPlansForGenericResource(genericResourceId: number, plannedTimeBreakdown?: Array<string>, from?: string, to?: string, updatedFrom?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param updatedFrom Retrieve plans that have been updated from this date
     */
    getPlansForUser(accountId: string, plannedTimeBreakdown?: Array<string>, from?: string, to?: string, updatedFrom?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    searchPlans(planSearchInput?: PlanSearchInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageablePlanBeanWithoutLinks;
    }>;
    /**
     ...
     * @param planInput
     */
    updatePartialPlan(id: number, day: string, planInput?: PlanInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param planInput
     */
    updatePlan(id: number, planInput?: PlanInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=plansApi.d.ts.map