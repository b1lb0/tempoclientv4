...
export declare class SkillsApi {
     ...
     * @param skillInput
     */
    createSkill(skillInput?: SkillInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getSkills(id?: Array<number>, query?: string, offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param skillInput
     */
    updateSkill(id: number, skillInput?: SkillInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
