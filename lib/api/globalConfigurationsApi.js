...
exports.GlobalConfigurationsApi = exports.GlobalConfigurationsApiApiKeys = void 0;
...
// ===============================================
var GlobalConfigurationsApiApiKeys;
(function (GlobalConfigurationsApiApiKeys) {
})(GlobalConfigurationsApiApiKeys || (exports.GlobalConfigurationsApiApiKeys = GlobalConfigurationsApiApiKeys = {}));
var GlobalConfigurationsApi = /** @class */ (function () {
    function GlobalConfigurationsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(GlobalConfigurationsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(GlobalConfigurationsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(GlobalConfigurationsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    GlobalConfigurationsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    GlobalConfigurationsApi.prototype.setApiKey = function (key, value) {
        this.authentications[GlobalConfigurationsApiApiKeys[key]].apiKey = value;
    };
    GlobalConfigurationsApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    GlobalConfigurationsApi.prototype.getGlobalConfiguration = function () {
        return __awaiter(this, arguments, void 0, function (options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/globalconfiguration';
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "GlobalConfiguration");
    ...
    return GlobalConfigurationsApi;
}());
exports.GlobalConfigurationsApi = GlobalConfigurationsApi;
