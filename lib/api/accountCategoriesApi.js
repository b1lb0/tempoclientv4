...
exports.AccountCategoriesApi = exports.AccountCategoriesApiApiKeys = void 0;
...
// ===============================================
var AccountCategoriesApiApiKeys;
(function (AccountCategoriesApiApiKeys) {
    AccountCategoriesApiApiKeys["Bearer"] = "Bearer";
})(AccountCategoriesApiApiKeys || (exports.AccountCategoriesApiApiKeys = AccountCategoriesApiApiKeys = {}));
var AccountCategoriesApi = /** @class */ (function () {
    function AccountCategoriesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AccountCategoriesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AccountCategoriesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(AccountCategoriesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    AccountCategoriesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AccountCategoriesApi.prototype.setApiKey = function (key, value) {
        this.authentications[AccountCategoriesApiApiKeys[key]].apiKey = value;
    };
    AccountCategoriesApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param categoryInput
     */
    AccountCategoriesApi.prototype.createCategory = function (categoryInput_1) {
        return __awaiter(this, arguments, void 0, function (categoryInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/account-categories';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(categoryInput, "CategoryInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "Category");
     ...
     * @param key
     */
    AccountCategoriesApi.prototype.deleteCategory = function (key_1) {
        return __awaiter(this, arguments, void 0, function (key, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/account-categories/{key}'
                ...
                if (key === null || key === undefined) {
                    throw new Error('Required parameter key was null or undefined when calling deleteCategory.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param id
     */
    AccountCategoriesApi.prototype.getCategories = function (id_1) {
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "CategoryResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param key
     */
    AccountCategoriesApi.prototype.getCategoryByKey = function (key_1) {
        return __awaiter(this, arguments, void 0, function (key, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'key' is not null or undefined
                if (key === null || key === undefined) {
                    throw new Error('Required parameter key was null or undefined when calling getCategoryByKey.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     * @param key A set of characters that uniquely identify the category to be updated
     * @param categoryInput
     */
    AccountCategoriesApi.prototype.updateCategory = function (key_1, categoryInput_1) {
        return __awaiter(this, arguments, void 0, function (key, categoryInput, options) {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'key' is not null or undefined
                if (key === null || key === undefined) {
                    throw new Error('Required parameter key was null or undefined when calling updateCategory.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
    ...
    return AccountCategoriesApi;
}());
exports.AccountCategoriesApi = AccountCategoriesApi;
