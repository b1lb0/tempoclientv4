...
export declare enum WorkAttributesApiApiKeys {
}
export declare class WorkAttributesApi {
    ...
    setApiKey(key: WorkAttributesApiApiKeys, value: string): void;
     ...
     */
    createWorkAttributes(createWorkAttributeInput?: CreateWorkAttributeInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param key
     */
    deleteWorkAttributeByKey(key: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param key
     */
    getWorkAttributeByKey(key: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getWorkAttributes(offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageableWorkAttribute;
    }>;
    /**
     ...
     */
    updateWorkAttributeByKey(key: string, updateWorkAttributeInput?: UpdateWorkAttributeInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=workAttributesApi.d.ts.map