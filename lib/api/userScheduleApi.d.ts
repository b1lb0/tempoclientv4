...
export declare enum UserScheduleApiApiKeys {
}
export declare class UserScheduleApi {
    ...
    setApiKey(key: UserScheduleApiApiKeys, value: string): void;
     ...
     */
    getAuthenticatedUserSchedule(from: string, to: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: DayScheduleResults;
    }>;
    /**
     ...
     * @param to The end date in format yyyy-mm-dd
     */
    getUserSchedule(accountId: string, from: string, to: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=userScheduleApi.d.ts.map