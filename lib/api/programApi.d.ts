...
export declare class ProgramApi {
     ...
     * @param programInput
     */
    createProgram(programInput?: ProgramInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id
     */
    deleteProgram(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id
     */
    getProgramById(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id
     */
    getTeamsByProgramId(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param programInput
     */
    updateProgram(id: string, programInput?: ProgramInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=programApi.d.ts.map