...
export declare enum TeamMembershipsApiApiKeys {
}
export declare class TeamMembershipsApi {
    ...
    setApiKey(key: TeamMembershipsApiApiKeys, value: string): void;
     ...
     */
    createMembership(teamMembershipInput?: TeamMembershipInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id
     */
    deleteMembership(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param teamId
     */
    getAllMemberships(teamId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: TeamMembershipResults;
    }>;
    /**
     ...
     * @param id
     */
    getMembership(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    searchMemberships(offset?: number, limit?: number, membershipSearchInput?: MembershipSearchInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: TeamMembershipResultsPageable;
    }>;
    /**
     ...
     */
    updateMembership(id: string, membershipInput?: MembershipInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=teamMembershipsApi.d.ts.map