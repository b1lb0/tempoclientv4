...
exports.PeriodsApi = exports.PeriodsApiApiKeys = void 0;
...
// ===============================================
var PeriodsApiApiKeys;
(function (PeriodsApiApiKeys) {
})(PeriodsApiApiKeys || (exports.PeriodsApiApiKeys = PeriodsApiApiKeys = {}));
var PeriodsApi = /** @class */ (function () {
    function PeriodsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PeriodsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PeriodsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(PeriodsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    PeriodsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PeriodsApi.prototype.setApiKey = function (key, value) {
        this.authentications[PeriodsApiApiKeys[key]].apiKey = value;
    };
    PeriodsApi.prototype.addInterceptor = function (interceptor) {
        ...
        return __awaiter(this, arguments, void 0, function (from, to, options) {
            ...
            return __generator(this, function (_b) {
                ...
                if (from === null || from === undefined) {
                    throw new Error('Required parameter from was null or undefined when calling getPeriods.');
                }
                // verify required parameter 'to' is not null or undefined
                if (to === null || to === undefined) {
                    throw new Error('Required parameter to was null or undefined when calling getPeriods.');
                }
                if (from !== undefined) {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TimesheetApprovalPeriodsBean");
