...
export declare enum PermissionRolesApiApiKeys {
}
export declare class PermissionRolesApi {
    ...
    setApiKey(key: PermissionRolesApiApiKeys, value: string): void;
     ...
     */
    createPermissionGroup(permissionRoleInput?: PermissionRoleInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param id
     */
    deleteEditablePermissionGroup(id: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getGlobalPermissionRoles(offset?: number, limit?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: PageablePermissionRole;
    }>;
    /**
     ...
     */
    getPermissionRole(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getPermissionRoles(offset?: number, limit?: number, teamId?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param permissionRoleInput
     */
    updatePermissionGroup(id: number, permissionRoleInput?: PermissionRoleInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
...
//# sourceMappingURL=permissionRolesApi.d.ts.map