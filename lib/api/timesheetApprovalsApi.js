...
exports.TimesheetApprovalsApi = exports.TimesheetApprovalsApiApiKeys = void 0;
...
// ===============================================
var TimesheetApprovalsApiApiKeys;
(function (TimesheetApprovalsApiApiKeys) {
})(TimesheetApprovalsApiApiKeys || (exports.TimesheetApprovalsApiApiKeys = TimesheetApprovalsApiApiKeys = {}));
var TimesheetApprovalsApi = /** @class */ (function () {
    function TimesheetApprovalsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(TimesheetApprovalsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(TimesheetApprovalsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(TimesheetApprovalsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    TimesheetApprovalsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    TimesheetApprovalsApi.prototype.setApiKey = function (key, value) {
        this.authentications[TimesheetApprovalsApiApiKeys[key]].apiKey = value;
    };
    TimesheetApprovalsApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    TimesheetApprovalsApi.prototype.approveTimesheetForUser = function (accountId_1, from_1, to_1, timesheetApprovalInput_1) {
        return __awaiter(this, arguments, void 0, function (accountId, from, to, timesheetApprovalInput, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/approve'
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(timesheetApprovalInput, "TimesheetApprovalInput")
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TimesheetApproval");
     ...
     * @param to The End Date in format yyyy-mm-dd
     */
    TimesheetApprovalsApi.prototype.getTimesheetApprovalForTeam = function (teamId_1, from_1, to_1) {
        return __awaiter(this, arguments, void 0, function (teamId, from, to, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/timesheet-approvals/team/{teamId}'
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TimesheetApprovalResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param to The End Date in format yyyy-mm-dd
     */
    TimesheetApprovalsApi.prototype.getTimesheetApprovalForUser = function (accountId_1, from_1, to_1) {
        return __awaiter(this, arguments, void 0, function (accountId, from, to, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}'
                    .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
     ...
     */
    TimesheetApprovalsApi.prototype.getTimesheetApprovalsWaitingForApproval = function () {
        return __awaiter(this, arguments, void 0, function (options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/timesheet-approvals/waiting';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
     ...
     * @param accountId
     */
    TimesheetApprovalsApi.prototype.getTimesheetReviewersForUser = function (accountId_1) {
        return __awaiter(this, arguments, void 0, function (accountId, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/reviewers'
                    .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "UserResults");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new _1.HttpError(response, body, response.statusCode));
     ...
     * @param timesheetApprovalInput
     */
    TimesheetApprovalsApi.prototype.rejectTimesheetForUser = function (accountId_1, from_1, to_1, timesheetApprovalInput_1) {
        return __awaiter(this, arguments, void 0, function (accountId, from, to, timesheetApprovalInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/reject'
                    .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
     ...
     * @param timesheetApprovalInput
     */
    TimesheetApprovalsApi.prototype.reopenTimesheetForUser = function (accountId_1, from_1, to_1, timesheetApprovalInput_1) {
        return __awaiter(this, arguments, void 0, function (accountId, from, to, timesheetApprovalInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/reopen'
                    .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
     ...
     * @param timesheetApprovalInput
     */
    TimesheetApprovalsApi.prototype.submitTimesheetForUser = function (accountId_1, from_1, to_1, timesheetApprovalInput_1) {
        return __awaiter(this, arguments, void 0, function (accountId, from, to, timesheetApprovalInput, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/timesheet-approvals/user/{accountId}/submit'
                    .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
    ...
    return TimesheetApprovalsApi;
}());
exports.TimesheetApprovalsApi = TimesheetApprovalsApi;
